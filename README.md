...
为加拿大移民语言考试准备的针对性词表。不是通用词汇书——每一条都绑定具体考试的具体题型。

| 词表 | 考试 | 目标 | 条目数 | 对照语言 |
|---|---|---|---|---|
| [`pte-core/`](pte-core/) | PTE Core（英语） | CLB 9 | 666 | 英 → 中 |
| [`tcf-canada/`](tcf-canada/) | TCF Canada（法语） | NCLC 7+ | 492 | 法 → 英 → 中 |
...
两份 README 里的分数对照表按公开资料整理，**IRCC 会调整换算标准，用之前请到官网
Language test equivalency charts 页面核对一次**。
