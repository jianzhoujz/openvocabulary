...
## EO1 · Expression orale Tâche 1 自我介绍

### 自我介绍

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| Je m'appelle… et je viens de… | expr. | My name is… and I come from… | 我叫……，我来自…… | Tâche 1 开口第一句，务必脱口而出 | Je m'appelle Jian et je viens de Chine. |
| Je suis originaire de | expr. | I am originally from | 我原籍是…… | 比 je viens de 更地道 | Je suis originaire de la région de Shanghai. |
| Cela fait … que | expr. | It has been … since | 已经……了 | 时间表达高分句型，后接现在时 | Cela fait cinq ans que je travaille dans ce domaine. |
| Je travaille en tant que | expr. | I work as | 我做……工作 | en tant que 后不加冠词 | Je travaille en tant qu'ingénieur. |
| Je suis passionné(e) par | expr. | I am passionate about | 我热衷于 | 介词是 par | Je suis passionné par la photographie. |
| Ce qui me plaît le plus, c'est | expr. | What I like most is | 我最喜欢的是 | 强调结构，考官爱听 | Ce qui me plaît le plus, c'est le contact humain. |
| dans mon temps libre | loc. | in my free time | 在我空闲时间 | 万能过渡 | Dans mon temps libre, je fais du vélo. |
| avoir l'habitude de | expr. | to be used to | 习惯于 | 后接动词原形 | J'ai l'habitude de me lever tôt. |
| depuis mon arrivée | loc. | since my arrival | 自从我到这里 | 移民话题高频 | Depuis mon arrivée, j'ai beaucoup appris. |
...
| Ça m'arrangerait plutôt | expr. | It would suit me better | 我更方便…… | 反提议 | Ça m'arrangerait plutôt en fin de journée. |
| Je vais y réfléchir | expr. | I will think about it | 我考虑一下 | 不当场答应 | Merci, je vais y réfléchir et je vous rappelle. |

### 表达情绪

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| Ça m'embête un peu | expr. | That bothers me a bit | 这让我有点困扰 | 温和抱怨 | Ça m'embête un peu, ce bruit tous les soirs. |
| Je suis vraiment déçu(e) | expr. | I am really disappointed | 我真的很失望 | 投诉场景 | Je suis vraiment déçu de la qualité du service. |
| Je vous remercie infiniment | expr. | Thank you so much | 万分感谢 | 高阶感谢 | Je vous remercie infiniment de votre aide. |
| Ce n'est pas grave | expr. | It is not a big deal | 没关系 | 接受道歉 | Ce n'est pas grave, ça arrive. |
| Je comprends tout à fait | expr. | I completely understand | 我完全理解 | 共情，互动加分 | Je comprends tout à fait votre situation. |

## ARGU · Tâche 3 论证与观点表达（笔试口试通用）

### 引入话题

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| De nos jours | loc. | Nowadays | 如今 | Tâche 3 开场万能 | De nos jours, le télétravail est très répandu. |
| Il est indéniable que | expr. | It is undeniable that | 不可否认的是 | 开场高分句，后接直陈式 | Il est indéniable que la technologie a changé nos habitudes. |
| La question de … fait débat | expr. | The issue of … is debated | ……的问题引发争论 | Tâche 3 引出议题 | La question du logement fait débat depuis des années. |
| Ce sujet suscite de vives réactions | expr. | This topic provokes strong reactions | 该话题引发强烈反响 | 高分开场 | Ce sujet suscite de vives réactions dans la société. |
| Il convient de s'interroger sur | expr. | It is worth questioning | 有必要思考 | 正式书面开场 | Il convient de s'interroger sur les conséquences de cette mesure. |

### 表明立场

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| À mon avis / Selon moi | loc. | In my opinion | 在我看来 | 基础表态，别重复用 | À mon avis, cette solution est la meilleure. |
| Je suis convaincu(e) que | expr. | I am convinced that | 我确信 | 比 je pense 有力 | Je suis convaincu que cette réforme est nécessaire. |
| Personnellement, je pense que | expr. | Personally, I think that | 我个人认为 | 口语过渡 | Personnellement, je pense que les deux avis se complètent. |
| Je partage plutôt le point de vue de | expr. | I rather share the view of | 我比较赞同……的观点 | Tâche 3 第二部分核心句 | Je partage plutôt le point de vue du deuxième auteur. |
| Je suis pour / contre | expr. | I am for / against | 我支持/反对 | 简明表态 | Je suis contre l'interdiction totale. |
| Il me semble que | expr. | It seems to me that | 我觉得 | 肯定形式后接直陈式 | Il me semble que cette approche est plus réaliste. |
| Je ne suis pas tout à fait d'accord | expr. | I do not entirely agree | 我不完全同意 | 有保留的反对，显成熟 | Je ne suis pas tout à fait d'accord avec cette idée. |
| prendre position | expr. | to take a stand | 表明立场 | Tâche 3 评分要求的动作 | Il faut prendre position clairement. |

### 引述文本

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| Le premier document souligne que | expr. | The first document stresses that | 第一篇文章强调 | Tâche 3 第一部分固定句 | Le premier document souligne les avantages du télétravail. |
| L'auteur affirme que | expr. | The author claims that | 作者主张 | 转述动词 | L'auteur affirme que la mesure est inefficace. |
| met en avant | expr. | highlights / puts forward | 凸显/提出 | 高分转述 | Le texte met en avant les risques pour la santé. |
| dénonce | v. | denounces / criticises | 抨击 | 带批判色彩的转述 | Le second auteur dénonce le manque de moyens. |
| nuance son propos | expr. | qualifies his/her statement | 使观点更细致 | 高分转述 | L'auteur nuance son propos en fin de texte. |
| s'oppose à | v. | opposes | 反对 | 对比两文观点 | Le deuxième document s'oppose à cette vision. |
| rejoint l'idée de | expr. | agrees with the idea of | 与……观点一致 | 对比两文的另一面 | Ce point de vue rejoint l'idée du premier texte. |

### 论证展开

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| D'une part … d'autre part | loc. | On the one hand … on the other hand | 一方面……另一方面 | 成对出现，缺一不可 | D'une part le coût baisse, d'autre part la qualité souffre. |
| Tout d'abord … Ensuite … Enfin | loc. | First … Then … Finally | 首先……其次……最后 | 最安全的三段结构 | Tout d'abord, c'est économique. Ensuite, c'est écologique. |
| En premier lieu / En second lieu | loc. | Firstly / Secondly | 第一/第二 | 比 premièrement 正式 | En premier lieu, il faut considérer le coût. |
| De plus / Par ailleurs | loc. | Moreover / Furthermore | 此外 | 递进，par ailleurs 更书面 | Par ailleurs, cette solution est plus rapide. |
| Non seulement … mais aussi | loc. | Not only … but also | 不仅……而且 | 高分并列结构 | Non seulement c'est cher, mais aussi peu fiable. |
| Prenons l'exemple de | expr. | Let us take the example of | 以……为例 | 举例，比 par exemple 更有力 | Prenons l'exemple du transport en commun. |
| C'est le cas de | expr. | This is the case of | ……就是一例 | 举例变体 | C'est le cas de nombreuses familles. |
| En effet | adv. | Indeed | 确实/因为 | 承接并解释上一句，非常高频 | En effet, les loyers ont doublé en dix ans. |
| Autrement dit | loc. | In other words | 换句话说 | 改述，显示语言储备 | Autrement dit, la mesure profite surtout aux riches. |
| Cela s'explique par | expr. | This can be explained by | 这可以由……解释 | 因果高分句 | Cela s'explique par le manque de logements. |

### 让步转折

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| Certes … mais | loc. | Admittedly … but | 诚然……但是 | 让步结构，TCF 评分喜欢 | Certes, c'est coûteux, mais les bénéfices sont durables. |
| Il est vrai que … cependant | loc. | It is true that … however | 确实……然而 | 与 certes 轮换 | Il est vrai que cela demande du temps, cependant le résultat en vaut la peine. |
| Toutefois / Néanmoins | adv. | However / Nevertheless | 然而/尽管如此 | 正式转折，胜过 mais | Néanmoins, certains risques subsistent. |
| En revanche / Par contre | loc. | On the other hand / In contrast | 相反地 | par contre 更口语，en revanche 更书面 | En revanche, le coût reste élevé. |
| Bien que + 虚拟式 | conj. | Although | 尽管 | 必须接虚拟式，考点 | Bien que ce soit difficile, cela reste possible. |
| Même si + 直陈式 | conj. | Even if / Even though | 即使 | 接直陈式，与 bien que 区分 | Même si le prix augmente, la demande reste forte. |
| Malgré + 名词 | prep. | Despite | 尽管 | 后只能接名词，不接从句 | Malgré les difficultés, le projet a abouti. |
| Or | conj. | Now / Yet | 然而（引出转折事实） | 书面高分连词 | Or, les chiffres montrent le contraire. |

### 因果结果

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| Par conséquent / Ainsi | adv. | Consequently / Thus | 因此 | 正式因果 | Par conséquent, la ville a modifié sa politique. |
| C'est pourquoi | loc. | That is why | 这就是为什么 | 结果连接 | C'est pourquoi je soutiens cette proposition. |
| Étant donné que | conj. | Given that | 鉴于 | 正式引出原因 | Étant donné que les ressources sont limitées, il faut choisir. |
| Grâce à / À cause de | prep. | Thanks to / Because of | 多亏/由于 | grâce à 褒义，à cause de 贬义，必须区分 | Grâce à ce programme, j'ai trouvé un emploi. |
| entraîner / provoquer | v. | to lead to / to cause | 导致 | 因果动词，比 causer 高级 | Cette décision a entraîné de nombreuses protestations. |
| avoir des répercussions sur | expr. | to have repercussions on | 对……产生影响 | 高分搭配 | Cela a des répercussions sur la vie quotidienne. |

### 结论

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| En conclusion / Pour conclure | loc. | In conclusion | 总之 | 结尾必备 | Pour conclure, je dirais que les deux approches sont complémentaires. |
| En somme / En définitive | loc. | All in all / Ultimately | 总而言之 | 结尾轮换词 | En définitive, la prudence s'impose. |
| il serait souhaitable de | expr. | it would be desirable to | 最好能够 | 条件式建议，高分收尾 | Il serait souhaitable de renforcer les contrôles. |
| un juste équilibre entre | expr. | a fair balance between | 在……之间的平衡 | 万能折中结论 | Il faut trouver un juste équilibre entre liberté et sécurité. |
| à condition que + 虚拟式 | loc. | provided that | 只要/条件是 | 带条件的结论，高分 | Cette solution fonctionne, à condition que tous participent. |

## EE · Expression écrite 功能语块

### Tâche1-称呼

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| Cher Monsieur / Chère Madame | expr. | Dear Sir / Dear Madam | 尊敬的先生/女士 | 正式书信开头，形容词要配性 | Chère Madame Tremblay, |
| Salut + 名字 | expr. | Hi + name | 嗨，…… | 写给朋友，Tâche 1 常见 | Salut Marie, |
| Bonjour à tous | expr. | Hello everyone | 大家好 | 写给群体（同事、邻居） | Bonjour à tous, |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| Je suis vraiment désolé(e) de | expr. | I am truly sorry for | 我为……深感抱歉 | 后接原形或过去不定式 | Je suis vraiment désolé de ne pas avoir répondu plus tôt. |
| Veuillez m'excuser pour | expr. | Please excuse me for | 请原谅我…… | 正式道歉，veuillez 是命令式 | Veuillez m'excuser pour ce retard. |
| Je vous prie de m'excuser | expr. | I beg your pardon | 请您原谅 | 最正式道歉 | Je vous prie de m'excuser pour ce contretemps. |

### Tâche1-投诉

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| Je tiens à vous signaler que | expr. | I wish to report that | 我要向您反映 | 投诉正式开场 | Je tiens à vous signaler que le chauffage ne fonctionne plus. |
| à plusieurs reprises | loc. | on several occasions | 多次 | 强化投诉 | Je vous ai contacté à plusieurs reprises, sans réponse. |
| sans succès / en vain | loc. | without success / in vain | 未果 | 投诉升级 | J'ai essayé de vous joindre, mais en vain. |
| Je compte sur vous pour | expr. | I am counting on you to | 我指望您…… | 施压但礼貌 | Je compte sur vous pour régler ce problème rapidement. |
| dans les meilleurs délais | loc. | as soon as possible | 尽快 | 正式催促，胜过 vite | Merci de traiter ma demande dans les meilleurs délais. |

### Tâche1-结尾

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| Dans l'attente de votre réponse | expr. | Looking forward to your reply | 静候回复 | 正式结尾固定句 | Dans l'attente de votre réponse, je vous remercie. |
| N'hésite pas à me contacter | expr. | Do not hesitate to contact me | 随时联系我 | 非正式结尾 | N'hésite pas à me contacter si tu as des questions. |
| Je reste à votre disposition | expr. | I remain at your disposal | 随时为您效劳 | 正式结尾高分 | Je reste à votre disposition pour tout renseignement complémentaire. |

### Tâche1-落款

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| Cordialement | expr. | Kind regards | 此致 | 半正式最安全落款 | Cordialement, Jian Zhou |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| Il y a quelques mois | loc. | A few months ago | 几个月前 | Tâche 2 叙事开头 | Il y a quelques mois, j'ai vécu une expérience marquante. |
| Au début / Au bout de | loc. | At first / After (a period) | 起初/经过……之后 | 时间推进 | Au bout de trois semaines, tout allait mieux. |
| Ce jour-là | loc. | That day | 那天 | 叙事中定位时间 | Ce jour-là, il neigeait énormément. |
| Soudain / Tout à coup | adv. | Suddenly | 突然 | 叙事转折 | Tout à coup, la lumière s'est éteinte. |
| Finalement | adv. | In the end | 最终 | 叙事收束 | Finalement, tout s'est bien passé. |
| Ce qui m'a le plus marqué(e), c'est | expr. | What struck me most was | 最让我印象深刻的是 | 叙事加评论的桥梁句，高分 | Ce qui m'a le plus marqué, c'est l'accueil des gens. |
| J'ai été agréablement surpris(e) par | expr. | I was pleasantly surprised by | 我惊喜地发现 | 正面评论 | J'ai été agréablement surpris par la qualité du service. |
| Avec le recul | loc. | In hindsight | 回过头看 | 成熟评论视角，高分 | Avec le recul, je pense que c'était la bonne décision. |
| Cette expérience m'a appris que | expr. | This experience taught me that | 这段经历让我明白 | Tâche 2 万能结论句 | Cette expérience m'a appris que la patience est essentielle. |
| Je recommande vivement | expr. | I strongly recommend | 我强烈推荐 | 带建议的收尾 | Je recommande vivement cette activité à tout le monde. |

### 通用

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| il s'agit de | expr. | it is about / it concerns | 涉及的是 | 无人称结构，书面高频 | Il s'agit d'un problème récurrent. |
| mettre en place | expr. | to set up / to implement | 建立/实施 | 万能高分动词搭配 | La ville a mis en place un nouveau service. |
| faire face à | expr. | to face / to cope with | 面对 | 高分搭配 | Les nouveaux arrivants font face à plusieurs défis. |
| tenir compte de | expr. | to take into account | 考虑到 | 正式搭配 | Il faut tenir compte du coût de la vie. |
| avoir recours à | expr. | to resort to | 求助于 | 书面高分 | De plus en plus de gens ont recours au télétravail. |
| permettre de + 原形 | v. | to make it possible to | 使得可以 | 万能句型 | Cette mesure permet de réduire les coûts. |
| empêcher de + 原形 | v. | to prevent from | 阻止 | 与 permettre 成对 | Le bruit m'empêche de dormir. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| le courriel | n.m. | email | 电子邮件 | 魁北克坚持用 courriel，法国说 e-mail/mail | Je vous enverrai les documents par courriel. |
| le stationnement | n.m. | parking | 停车场/停车位 | 魁北克不说 parking，这是高频听力词 | Le stationnement est gratuit le soir. |
| la fin de semaine | n.f. | weekend | 周末 | 魁北克不说 week-end，TCF 听力常出现 | On se voit la fin de semaine prochaine ? |
| magasiner / le magasinage | v./n.m. | to shop / shopping | 购物 | 魁北克说法，法国说 faire du shopping | Je vais magasiner cet après-midi. |
| le dépanneur | n.m. | convenience store | 便利店 | 魁北克独有词，考试与生活双高频 | Il y a un dépanneur au coin de la rue. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| le CLSC | n.m. | local community health centre | 社区健康服务中心 | 魁北克医疗体系入口，听力必考缩写 | Je dois prendre rendez-vous au CLSC. |
| la RAMQ | n.f. | Quebec health insurance board | 魁北克医保局 | 发放 carte soleil 医保卡 | Ma carte de la RAMQ expire en mars. |
| le cégep | n.m. | pre-university/technical college | 大学预科兼技术学院 | 魁北克独有学制，高中与大学之间两年 | Ma fille commence le cégep en septembre. |
| la SAQ | n.f. | Quebec liquor board | 魁北克酒类专卖局 | 买酒只能去 SAQ | On achète le vin à la SAQ. |
| la SAAQ | n.f. | Quebec auto insurance board | 魁北克车辆保险局 | 办驾照和车牌 | Il faut renouveler le permis à la SAAQ. |
| Service Canada | n.pr. | Service Canada | 加拿大服务部 | 办 NAS、assurance-emploi | Je me suis rendu à un bureau de Service Canada. |
| la garderie / le CPE | n.f./n.m. | daycare / early childhood centre | 托儿所 | 魁北克补贴托儿是重要社会议题 | Les places en garderie sont très demandées. |
| la commission scolaire / le centre de services scolaire | n.f./n.m. | school board | 教育局 | 魁北克 2020 年改名，两种说法都可能听到 | Le centre de services scolaire a annoncé une journée pédagogique. |
| la municipalité / la ville | n.f. | municipality / city | 市政府 | 三级政府之一 | La municipalité s'occupe du déneigement. |

### 移民身份

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| la résidence permanente | n.f. | permanent residence | 永久居留 | 移民核心词 | J'ai obtenu ma résidence permanente l'an dernier. |
| le résident permanent | n.m. | permanent resident | 永久居民 | 身份称谓 | Les résidents permanents peuvent travailler partout au Canada. |
| la citoyenneté canadienne | n.f. | Canadian citizenship | 加拿大公民身份 | 入籍话题 | La demande de citoyenneté prend plusieurs mois. |
| le permis de travail | n.m. | work permit | 工作许可 | 临时身份 | Mon permis de travail est valide deux ans. |
| le nouvel arrivant | n.m. | newcomer | 新移民 | 加拿大官方常用词，比 immigrant 中性 | Des ateliers gratuits sont offerts aux nouveaux arrivants. |
| le parrainage | n.m. | sponsorship | 担保移民 | 家庭团聚 | Elle a déposé une demande de parrainage pour ses parents. |
| l'intégration | n.f. | integration | 融入 | 社会议题高频 | L'intégration des nouveaux arrivants passe par la langue. |
| la francisation | n.f. | French-language training | 法语培训（政府免费） | 魁北克独有项目名，听力高频 | Je suis des cours de francisation le soir. |
| l'équivalence de diplôme | n.f. | credential recognition | 学历认证 | 就业障碍话题 | L'équivalence de diplôme est un obstacle fréquent. |
| l'ordre professionnel | n.m. | professional order/regulatory body | 职业行会 | 魁北克执业准入机构 | Il faut être membre de l'ordre professionnel pour exercer. |

### 社会福利

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| le NAS (numéro d'assurance sociale) | n.m. | Social Insurance Number | 社会保险号 | 工作必备，听力会念全称 | Vous devez fournir votre NAS à l'employeur. |
| l'assurance-emploi | n.f. | Employment Insurance | 就业保险 | 失业与产假津贴 | Il touche l'assurance-emploi depuis deux mois. |
| le congé parental | n.m. | parental leave | 育儿假 | 魁北克 RQAP 制度，社会议题 | Le congé parental est partagé entre les deux parents. |
| les allocations familiales | n.f.pl. | child benefits | 儿童福利金 | 家庭补贴 | Les allocations familiales sont versées chaque mois. |
| le REER / le CELI | n.m. | RRSP / TFSA | 注册退休储蓄计划/免税储蓄账户 | 加拿大理财必备缩写 | Je cotise à mon REER chaque année. |
| la déclaration de revenus | n.f. | tax return | 报税表 | 每年四月 | J'ai produit ma déclaration de revenus en ligne. |
| le salaire minimum | n.m. | minimum wage | 最低工资 | 社会议题 | Le salaire minimum a augmenté en mai. |
...
| la tempête de neige | n.f. | snowstorm | 暴风雪 | 听力通知类高频 | Les écoles sont fermées à cause de la tempête de neige. |
...
| la pelle à neige | n.f. | snow shovel | 雪铲 | 生活场景 | J'ai acheté une pelle à neige au magasin. |
| les pneus d'hiver | n.m.pl. | winter tires | 冬季轮胎 | 魁北克法律强制，12月至3月 | Les pneus d'hiver sont obligatoires au Québec. |
| la tuque / les mitaines | n.f. | toque / mittens | 毛线帽/连指手套 | 魁北克特有说法 | N'oublie pas ta tuque, il fait froid ! |
| le facteur vent / le refroidissement éolien | n.m. | wind chill | 体感温度 | 天气预报固定表达 | Avec le facteur vent, on ressent moins vingt. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| la cabane à sucre | n.f. | sugar shack | 枫糖屋 | 魁北克春季文化传统 | Au printemps, on va à la cabane à sucre en famille. |
| le sirop d'érable | n.m. | maple syrup | 枫糖浆 | 加拿大符号 | Le Québec produit la majorité du sirop d'érable mondial. |
| la poutine | n.f. | poutine | 肉汁奶酪薯条 | 魁北克国菜 | La poutine est un plat emblématique du Québec. |
| le pourboire | n.m. | tip | 小费 | 北美必须给，通常 15 到 20 个百分点 | Le pourboire n'est pas inclus dans l'addition. |
| les Premières Nations / les Autochtones | n.f.pl./n.m.pl. | First Nations / Indigenous peoples | 原住民 | 加拿大正确表述，社会议题必备 | Les Autochtones représentent une part importante de l'histoire du pays. |
| le bilinguisme | n.m. | bilingualism | 双语制 | 加拿大国策，议论题高频 | Le bilinguisme est inscrit dans la Constitution canadienne. |
| la Loi 101 / la Charte de la langue française | n.f. | Bill 101 / Charter of the French Language | 法语宪章 | 魁北克语言政策，社会议题核心 | La Loi 101 impose le français comme langue de travail. |
| l'interculturalisme / le multiculturalisme | n.m. | interculturalism / multiculturalism | 跨文化主义/多元文化主义 | 魁北克用前者，联邦用后者，区别是考点 | Le Québec défend un modèle d'interculturalisme. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| l'offre d'emploi | n.f. | job posting | 招聘启事 | CE 小广告题高频 | J'ai vu votre offre d'emploi sur votre site. |
| le curriculum vitæ / le CV | n.m. | résumé / CV | 简历 | 发音 cé-vé | Veuillez trouver ci-joint mon CV. |
| la lettre de motivation | n.f. | cover letter | 求职信 | 法语区必备文件 | J'ai joint une lettre de motivation à ma candidature. |
| poser sa candidature / postuler | v. | to apply | 申请职位 | postuler à un poste | Je souhaite postuler au poste d'adjoint administratif. |
| l'entretien d'embauche / l'entrevue | n.m./n.f. | job interview | 面试 | 加拿大说 entrevue，法国说 entretien | J'ai une entrevue vendredi matin. |
| l'expérience professionnelle | n.f. | work experience | 工作经验 | 简历核心 | J'ai dix ans d'expérience professionnelle dans ce secteur. |
| les compétences | n.f.pl. | skills | 技能 | 永远复数 | Mes compétences correspondent au profil recherché. |
| la période d'essai | n.f. | probation period | 试用期 | 合同条款 | La période d'essai dure trois mois. |
| embaucher / recruter | v. | to hire / to recruit | 雇佣/招聘 | 与 licencier 相对 | L'entreprise a embauché vingt personnes. |

### 雇佣条款

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| le contrat à durée indéterminée (CDI) | n.m. | permanent contract | 无固定期限合同 | 与 CDD 成对，听力缩写 | Il a signé un CDI le mois dernier. |
| le contrat à durée déterminée (CDD) | n.m. | fixed-term contract | 固定期限合同 | 临时合同 | Mon CDD se termine en décembre. |
| à temps plein / à temps partiel | loc. | full-time / part-time | 全职/兼职 | 固定搭配 | Je cherche un emploi à temps partiel. |
| le salaire brut / net | n.m. | gross / net salary | 税前/税后工资 | 工资单核心区分 | Le salaire net est d'environ 3 000 dollars. |
| les heures supplémentaires | n.f.pl. | overtime | 加班 | 永远复数 | Les heures supplémentaires sont payées à taux et demi. |
| les avantages sociaux | n.m.pl. | employee benefits | 福利待遇 | 加拿大求职核心词 | Le poste offre de bons avantages sociaux. |
| le congé payé | n.m. | paid leave | 带薪假 | 福利 | J'ai droit à trois semaines de congés payés. |
| le congé de maladie | n.m. | sick leave | 病假 | 请假场景 | J'ai pris deux jours de congé de maladie. |
| le préavis | n.m. | notice period | 离职通知期 | 辞职流程 | Je dois donner un préavis de deux semaines. |

### 日常职场

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| le collègue / la collègue | n. | colleague | 同事 | 阴阳同形 | Ma collègue m'a remplacé hier. |
| le supérieur hiérarchique / le patron | n.m. | line manager / boss | 上司/老板 | Tâche 3 明确提到的收件人类型 | J'en ai parlé à mon supérieur hiérarchique. |
| la charge de travail | n.f. | workload | 工作量 | 协商与抱怨高频 | Ma charge de travail a beaucoup augmenté. |
| la date limite / l'échéance | n.f. | deadline | 截止日期 | respecter une échéance | Nous devons respecter l'échéance du 15 mai. |
| la réunion | n.f. | meeting | 会议 | assister à / reporter une réunion | La réunion a été reportée à jeudi. |
...
| le télétravail | n.m. | remote work | 远程办公 | TCF 议论题头号热点 | Le télétravail s'est généralisé depuis 2020. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| démissionner | v. | to resign | 辞职 | 主动离职 | Elle a démissionné après cinq ans. |
| licencier / mettre à pied | v. | to dismiss / to lay off | 解雇/临时裁员 | mise à pied 是加拿大常用说法 | Cinquante employés ont été mis à pied. |
| le chômage | n.f. | unemployment | 失业 | être au chômage | Le taux de chômage a baissé. |
| le harcèlement | n.m. | harassment | 骚扰 | 职场法规高频 | L'entreprise a une politique contre le harcèlement. |
| la discrimination à l'embauche | n.f. | hiring discrimination | 招聘歧视 | 移民就业议题 | La discrimination à l'embauche touche les nouveaux arrivants. |
| l'épuisement professionnel | n.m. | burnout | 职业倦怠 | 魁北克正式说法，避免英语 burn-out | L'épuisement professionnel est en hausse. |
| la santé et la sécurité au travail | n.f. | occupational health and safety | 职业健康与安全 | 加拿大法定术语 | La formation en santé et sécurité au travail est obligatoire. |
| la pénurie de main-d'œuvre | n.f. | labour shortage | 劳动力短缺 | 加拿大当前头号经济议题 | La pénurie de main-d'œuvre touche tous les secteurs. |
| le syndicat | n.m. | union | 工会 | 加拿大工会力量强 | Les employés sont représentés par un syndicat. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| le logement | n.m. | housing / accommodation | 住房 | 万能词，社会议题核心 | La crise du logement touche toutes les grandes villes. |
| le loyer | n.m. | rent | 房租 | payer le loyer | Le loyer a augmenté de cent dollars. |
| le propriétaire / le locataire | n.m. | landlord / tenant | 房东/租客 | 成对出现，Tâche 1 常见收件人 | J'ai écrit au propriétaire pour signaler la fuite. |
| le bail | n.m. | lease | 租约 | 复数 baux，签约动词 signer un bail | Mon bail se termine le 30 juin. |
| la caution / le dépôt de garantie | n.f./n.m. | security deposit | 押金 | 注意魁北克法律限制押金 | La caution correspond à un mois de loyer. |
| les charges | n.f.pl. | utilities / service charges | 杂费（水电等） | charges comprises 是广告高频 | Le loyer est de 900 dollars, charges comprises. |
...
| le colocataire / la colocation | n.m./n.f. | roommate / flat-share | 合租室友/合租 | 年轻人与学生高频 | Je cherche un colocataire pour partager le loyer. |
| emménager / déménager | v. | to move in / to move out | 搬入/搬家 | 魁北克 7 月 1 日是搬家日 | Nous déménageons le premier juillet. |
| visiter un appartement | v. | to view an apartment | 看房 | 不是 visit 旅游义 | J'aimerais visiter l'appartement cette semaine. |
| la petite annonce | n.f. | classified ad | 分类小广告 | CE 阅读题固定文体 | J'ai répondu à une petite annonce. |

### 维修

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| la fuite d'eau | n.f. | water leak | 漏水 | Tâche 1 投诉题最高频问题 | Il y a une fuite d'eau sous l'évier. |
| le chauffage | n.m. | heating | 暖气 | 加拿大冬季核心报修 | Le chauffage ne fonctionne plus depuis hier. |
| la panne / en panne | n.f./loc. | breakdown / out of order | 故障/坏了 | 万能故障表达 | L'ascenseur est en panne depuis trois jours. |
| réparer / la réparation | v./n.f. | to repair / repair | 维修 | 报修核心动词 | Les réparations ont été faites le jour même. |
| la moisissure | n.f. | mould | 霉菌 | 健康类严重报修理由 | Il y a de la moisissure dans la salle de bain. |
| l'infiltration | n.f. | water infiltration / seepage | 渗水 | 加拿大住房常见问题 | Une infiltration a endommagé le plafond. |
| le concierge | n.m. | building superintendent | 楼管 | 加拿大公寓管理员 | Le concierge viendra demain matin. |

### 邻里

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| le voisin / le voisinage | n.m. | neighbour / neighbourhood | 邻居/邻里 | Tâche 2 与 EO2 高频场景 | Mes voisins font du bruit tard le soir. |
| le bruit / le tapage nocturne | n.m. | noise / night-time disturbance | 噪音/夜间扰民 | tapage nocturne 是法律用语 | J'ai porté plainte pour tapage nocturne. |
| porter plainte | v. | to file a complaint | 投诉/报案 | 正式动词搭配 | Il a porté plainte auprès de la municipalité. |
| le règlement de l'immeuble | n.m. | building rules | 楼宇管理规定 | 规章语境 | Le règlement de l'immeuble interdit les animaux. |
| les ordures / le recyclage / le compost | n.f.pl./n.m. | garbage / recycling / compost | 垃圾/回收/厨余 | 加拿大三分类 | Le compost est ramassé le mardi. |

### 购房

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| acheter une maison | v. | to buy a house | 买房 | 生活规划话题 | Nous envisageons d'acheter une maison en banlieue. |
| l'hypothèque | n.f. | mortgage | 按揭贷款 | 加拿大用 hypothèque，法国说 prêt immobilier | Le taux d'hypothèque a encore augmenté. |
| la mise de fonds | n.f. | down payment | 首付 | 加拿大特有说法 | La mise de fonds minimale est de cinq pour cent. |
| les taxes municipales | n.f.pl. | property taxes | 房产税 | 房主年度支出 | Les taxes municipales sont payables en deux versements. |
| le courtier immobilier | n.m. | real estate broker | 房产经纪 | 加拿大说法 | Notre courtier immobilier a organisé trois visites. |
| la banlieue | n.f. | suburbs | 郊区 | 与 le centre-ville 相对 | Les prix sont plus abordables en banlieue. |

### 社会议题

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| la crise du logement | n.f. | housing crisis | 住房危机 | 加拿大当前头号议题，Tâche 3 高频 | La crise du logement frappe les jeunes familles. |
| le logement abordable | n.m. | affordable housing | 可负担住房 | 政策议题 | La ville promet plus de logements abordables. |
| l'itinérance | n.f. | homelessness | 无家可归 | 魁北克用 itinérance，法国说 sans-abrisme | L'itinérance augmente dans les grandes villes. |
| l'embourgeoisement | n.m. | gentrification | 中产化/绅士化 | 城市议题高分词 | L'embourgeoisement chasse les résidents de longue date. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| prendre rendez-vous | v. | to make an appointment | 预约 | 固定搭配，不加冠词 | J'aimerais prendre rendez-vous avec le docteur Roy. |
| le médecin de famille | n.m. | family doctor | 家庭医生 | 加拿大医疗入口，等候名单话题高频 | Il est difficile de trouver un médecin de famille. |
| la clinique sans rendez-vous | n.f. | walk-in clinic | 免预约诊所 | 加拿大特有就医方式 | Je suis allé à une clinique sans rendez-vous. |
| l'urgence / les urgences | n.f. | emergency room | 急诊 | 魁北克说 à l'urgence | L'attente à l'urgence était de six heures. |
| le spécialiste | n.m. | specialist | 专科医生 | 需转诊 | Mon médecin m'a référé à un spécialiste. |
| l'ordonnance / la prescription | n.f. | prescription | 处方 | 魁北克两者都用 | Le pharmacien a renouvelé mon ordonnance. |
| la pharmacie / le pharmacien | n.f./n.m. | pharmacy / pharmacist | 药房/药剂师 | 生活场景 | La pharmacie est ouverte jusqu'à 21 h. |
| la carte d'assurance maladie | n.f. | health card | 医保卡 | 魁北克俗称 carte soleil | N'oubliez pas votre carte d'assurance maladie. |
| la liste d'attente | n.f. | waiting list | 轮候名单 | 加拿大医疗体系高频批评点 | Il est sur une liste d'attente pour une opération. |
| se faire vacciner / la vaccination | v./n.f. | to get vaccinated / vaccination | 接种疫苗 | 公共卫生话题 | Il faut se faire vacciner chaque automne. |

### 症状

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| tomber malade | v. | to fall ill | 生病 | 基础表达 | Je suis tombé malade la semaine dernière. |
| avoir mal à | v. | to have a pain in | ……疼 | avoir mal à la tête / au dos | J'ai mal à la gorge depuis deux jours. |
| avoir de la fièvre | v. | to have a fever | 发烧 | 固定搭配 | Mon fils a de la fièvre depuis hier soir. |
| le rhume / la grippe | n.m./n.f. | cold / flu | 感冒/流感 | 区分轻重 | J'ai attrapé un gros rhume. |
| les effets secondaires | n.m.pl. | side effects | 副作用 | 永远复数 | Ce médicament a peu d'effets secondaires. |
| guérir / la guérison | v./n.f. | to recover / recovery | 痊愈 | 康复表达 | Il a mis trois semaines à guérir. |
| la maladie chronique | n.f. | chronic illness | 慢性病 | 健康议题 | Les maladies chroniques pèsent sur le système. |

### 健康生活

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| la santé mentale | n.f. | mental health | 心理健康 | Tâche 3 高频议题 | La santé mentale des jeunes inquiète les experts. |
| le bien-être | n.m. | well-being | 身心健康 | 高分抽象名词 | Les entreprises investissent dans le bien-être des employés. |
| le stress / stressant | n.m./adj. | stress / stressful | 压力/有压力的 | 现代生活议题 | Mon travail est très stressant en ce moment. |
| la sédentarité | n.f. | sedentary lifestyle | 久坐少动 | 健康议论高分词 | La sédentarité augmente les risques cardiovasculaires. |
| l'alimentation équilibrée | n.f. | balanced diet | 均衡饮食 | 固定搭配 | Une alimentation équilibrée est essentielle. |
| faire de l'exercice / du sport | v. | to exercise | 锻炼 | 不说 faire exercice | Je fais du sport trois fois par semaine. |
| le système de santé public | n.m. | public health system | 公共医疗体系 | 加拿大制度特征，议论必备 | Le système de santé public est gratuit mais engorgé. |
| le vieillissement de la population | n.m. | population ageing | 人口老龄化 | Tâche 3 高频议题 | Le vieillissement de la population pèse sur les services. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| le compte bancaire / le compte chèque | n.m. | bank account / chequing account | 银行账户/支票账户 | 加拿大账户类型 | J'ai ouvert un compte chèque à la succursale. |
| la carte de débit / de crédit | n.f. | debit / credit card | 借记卡/信用卡 | 支付方式 | La plupart des commerces acceptent la carte de débit. |
| le virement / le virement Interac | n.m. | transfer / e-transfer | 转账/加拿大电子转账 | Interac 是加拿大特有系统 | Je vais te faire un virement Interac ce soir. |
| le dépôt direct | n.m. | direct deposit | 工资直存 | 加拿大发薪标准方式 | Mon salaire est versé par dépôt direct. |
| retirer / déposer de l'argent | v. | to withdraw / to deposit money | 取款/存款 | 基础动词 | Je dois retirer de l'argent au guichet. |
| les frais bancaires | n.m.pl. | bank fees | 银行手续费 | 永远复数 | Les frais bancaires sont de 15 dollars par mois. |
| le taux d'intérêt | n.m. | interest rate | 利率 | 固定搭配 | Le taux d'intérêt a encore monté. |
| le dossier de crédit | n.m. | credit file / credit score | 信用记录 | 新移民必须建立 | Il faut bâtir son dossier de crédit dès l'arrivée. |

### 消费

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| la facture | n.f. | invoice / bill | 账单/发票 | Tâche 1 投诉题高频 | J'ai reçu une facture incorrecte. |
| le reçu | n.m. | receipt | 收据 | 退货必需 | Conservez votre reçu pour la garantie. |
| la garantie | n.f. | warranty | 保修 | 消费维权 | L'appareil est encore sous garantie. |
| le remboursement / rembourser | n.m./v. | refund / to refund | 退款 | 投诉核心诉求 | Je demande le remboursement intégral. |
| l'échange | n.m. | exchange | 换货 | 与退款并列 | Le magasin propose un échange mais pas de remboursement. |
| le rabais / la réduction | n.m./n.f. | discount | 折扣 | 魁北克常用 rabais | Il y a un rabais de vingt pour cent cette semaine. |
| les taxes | n.f.pl. | sales taxes | 销售税 | 加拿大标价不含税 | Le prix affiché ne comprend pas les taxes. |
| le coût de la vie | n.m. | cost of living | 生活成本 | Tâche 3 高频议题 | Le coût de la vie a explosé ces dernières années. |
| le pouvoir d'achat | n.m. | purchasing power | 购买力 | 经济议题高分词 | L'inflation réduit le pouvoir d'achat des ménages. |
| l'inflation | n.f. | inflation | 通货膨胀 | 时事必备 | L'inflation atteint quatre pour cent. |
| le budget / gérer son budget | n.m./v. | budget / to manage one's budget | 预算/理财 | 生活技能话题 | J'ai du mal à gérer mon budget ce mois-ci. |

### 保险

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| l'assurance habitation / automobile | n.f. | home / car insurance | 房屋保险/车险 | 生活必备 | L'assurance habitation est obligatoire pour les propriétaires. |
| la prime / la franchise | n.f. | premium / deductible | 保费/免赔额 | 北美保险两个核心概念 | La franchise de ma police est de 500 dollars. |
| faire une réclamation | v. | to file a claim | 索赔 | 加拿大说 réclamation，法国说 déclaration de sinistre | J'ai fait une réclamation après l'accident. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| le transport en commun | n.m. | public transit | 公共交通 | 加拿大说 transport en commun | Je prends le transport en commun tous les jours. |
| le métro / l'autobus | n.m. | subway / bus | 地铁/公交 | 魁北克说 autobus 全称 | L'autobus 24 passe toutes les dix minutes. |
| le tarif / le titre de transport | n.m. | fare / transit pass | 票价/车票 | CO 公告题高频 | Le tarif mensuel est de 97 dollars. |
| la correspondance | n.f. | transfer / connection | 换乘 | 交通与航班双用 | Il y a une correspondance à la station Berri. |
| l'arrêt / la station | n.m./n.f. | stop / station | 站点 | arrêt 指公交，station 指地铁 | Descendez au prochain arrêt. |
| le retard / être en retard | n.m./loc. | delay / to be late | 延误/迟到 | 通知与道歉场景 | Le train a vingt minutes de retard. |
| l'horaire | n.m. | schedule / timetable | 时刻表 | CO 公告题核心信息 | Consultez l'horaire sur le site de la société de transport. |
| la grève | n.f. | strike | 罢工 | 法语区高频新闻 | Une grève des transports est annoncée pour lundi. |
| accessible aux personnes à mobilité réduite | loc. | wheelchair accessible | 无障碍 | 加拿大公共设施标准表述 | Toutes les stations sont accessibles aux personnes à mobilité réduite. |

### 驾车

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| le permis de conduire | n.m. | driver's licence | 驾照 | 办事场景 | J'ai passé mon permis de conduire au Québec. |
| l'immatriculation | n.f. | vehicle registration | 车辆登记 | SAAQ 业务 | Le renouvellement de l'immatriculation se fait en ligne. |
| la contravention / le constat | n.f./n.m. | ticket / fine | 罚单 | 违章 | J'ai reçu une contravention pour excès de vitesse. |
| l'excès de vitesse | n.m. | speeding | 超速 | 交通违规 | L'excès de vitesse est la première cause d'accidents. |
| le covoiturage | n.m. | carpooling / ridesharing | 拼车 | 环保与省钱议题，EO2 角色扮演考过 | Le covoiturage réduit les coûts et la pollution. |
| les embouteillages / la congestion | n.m.pl./n.f. | traffic jams / congestion | 交通拥堵 | 城市议题 | Les embouteillages sont terribles aux heures de pointe. |
| l'heure de pointe | n.f. | rush hour | 高峰期 | 固定搭配 | J'évite de conduire à l'heure de pointe. |
...
| le billet aller-retour | n.m. | return ticket | 往返票 | 购票场景 | Un billet aller-retour pour Québec, s'il vous plaît. |
| le vol / le décollage / l'atterrissage | n.m. | flight / takeoff / landing | 航班/起飞/降落 | 机场场景 | Notre vol est retardé de deux heures. |
| les bagages / le bagage à main | n.m.pl./n.m. | luggage / carry-on | 行李/随身行李 | 机场必备 | Un seul bagage à main est autorisé. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| l'école primaire / secondaire | n.f. | primary / secondary school | 小学/中学 | 基础学制 | Mes enfants vont à l'école primaire du quartier. |
| l'université / la faculté | n.f. | university / faculty | 大学/院系 | 高等教育 | Elle étudie à l'Université de Montréal. |
| les frais de scolarité | n.m.pl. | tuition fees | 学费 | 永远复数 | Les frais de scolarité ont augmenté. |
| s'inscrire / l'inscription | v./n.f. | to register / registration | 注册 | 流程词 | Les inscriptions se terminent le 15 août. |
| le diplôme / diplômé(e) | n.m./adj. | degree / graduate | 文凭/毕业的 | 简历必备 | Je suis diplômé en génie civil. |
| la formation | n.f. | training / education | 培训/教育 | 万能词，比 éducation 常用 | J'ai suivi une formation en comptabilité. |
| le stage / le stagiaire | n.m. | internship / intern | 实习/实习生 | 不是 stage 舞台 | J'ai fait un stage de six mois en entreprise. |
| la bourse d'études | n.f. | scholarship | 奖学金 | 资助 | Elle a obtenu une bourse d'études. |
| l'apprentissage | n.m. | learning / apprenticeship | 学习/学徒制 | 一词两义 | L'apprentissage d'une langue demande du temps. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| la société | n.f. | society | 社会 | Tâche 3 的 fait de société 就是指这个 | Ce phénomène touche toute la société. |
| l'inégalité / les inégalités | n.f. | inequality | 不平等 | 议论核心词 | Les inégalités se creusent entre les régions. |
| la pauvreté | n.f. | poverty | 贫困 | 社会议题 | La pauvreté touche un enfant sur dix. |
| la classe moyenne | n.f. | middle class | 中产阶级 | 经济议题 | La classe moyenne est fragilisée par l'inflation. |
| la diversité | n.f. | diversity | 多样性 | 加拿大公共话语核心 | La diversité est une richesse pour la société. |
| l'égalité des chances | n.f. | equal opportunity | 机会平等 | 高分搭配 | L'école doit garantir l'égalité des chances. |
| les droits de la personne | n.m.pl. | human rights | 人权 | 加拿大说 droits de la personne，法国说 droits de l'homme | La Charte protège les droits de la personne. |
| la laïcité | n.f. | secularism | 世俗主义 | 魁北克敏感热点议题 | Le débat sur la laïcité divise la population. |
| le bénévolat / le bénévole | n.m. | volunteering / volunteer | 志愿服务/志愿者 | 加拿大社区生活核心 | Le bénévolat favorise l'intégration sociale. |
| la banque alimentaire | n.f. | food bank | 食物银行 | 社区互助 | Les dons à la banque alimentaire augmentent en hiver. |
| l'organisme communautaire | n.m. | community organisation | 社区组织 | 加拿大说法 | Un organisme communautaire offre de l'aide aux familles. |
| le vivre-ensemble | n.m. | social cohesion / living together | 共同生活 | 魁北克特有的公共话语词 | Le vivre-ensemble repose sur le respect mutuel. |
| le fossé des générations | n.m. | generation gap | 代沟 | 家庭议题 | Le fossé des générations s'accentue avec le numérique. |

### 家庭

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| la famille monoparentale | n.f. | single-parent family | 单亲家庭 | 家庭议题 | Les familles monoparentales sont plus vulnérables. |
| le conjoint / la conjointe | n. | spouse / partner | 配偶 | 加拿大法律与表格常用 | Mon conjoint travaille dans la santé. |
| élever des enfants | v. | to raise children | 养育孩子 | 固定搭配 | Élever des enfants coûte cher en ville. |
| la garde partagée | n.f. | shared custody | 共同监护 | 离婚议题 | Ils ont opté pour la garde partagée. |
| prendre soin de | v. | to take care of | 照顾 | 固定搭配 | Elle prend soin de ses parents âgés. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| l'environnement | n.m. | environment | 环境 | Tâche 3 高频主题 | La protection de l'environnement est une priorité. |
| les changements climatiques | n.m.pl. | climate change | 气候变化 | 加拿大用复数形式，法国说 le changement climatique | Les changements climatiques affectent nos hivers. |
| le réchauffement climatique | n.m. | global warming | 全球变暖 | 同义高频词 | Le réchauffement climatique accélère la fonte des glaces. |
| les gaz à effet de serre (GES) | n.m.pl. | greenhouse gases | 温室气体 | 政策文件高频缩写 | Le Canada veut réduire ses GES de moitié. |
| l'empreinte carbone | n.f. | carbon footprint | 碳足迹 | 个人行动角度 | Le vélo réduit votre empreinte carbone. |
| le développement durable | n.m. | sustainable development | 可持续发展 | 高分固定搭配 | Le développement durable guide nos décisions. |
| les énergies renouvelables | n.f.pl. | renewable energy | 可再生能源 | 魁北克水电特色 | Le Québec produit surtout de l'hydroélectricité. |
| le gaspillage alimentaire | n.m. | food waste | 食物浪费 | Tâche 3 实考议题 | Le gaspillage alimentaire représente un tiers de la production. |
| le plastique à usage unique | n.m. | single-use plastic | 一次性塑料 | 加拿大已立法禁用 | Le plastique à usage unique est interdit depuis 2023. |
| le tri sélectif / le recyclage | n.m. | waste sorting / recycling | 垃圾分类/回收 | 生活实践 | Le tri sélectif est obligatoire dans la municipalité. |
| la pollution / polluer | n.f./v. | pollution / to pollute | 污染 | 基础议题词 | La pollution de l'air aggrave l'asthme. |
| les feux de forêt | n.m.pl. | wildfires | 森林大火 | 加拿大近年重大事件 | Les feux de forêt ont dégradé la qualité de l'air. |
| la sensibilisation / sensibiliser | n.f./v. | awareness-raising | 提高意识 | 公益活动固定词 | La campagne vise à sensibiliser les jeunes. |
| prendre conscience de | v. | to become aware of | 意识到 | 高分搭配 | Il faut prendre conscience de l'urgence. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| le numérique | n.m. | digital / digital technology | 数字技术 | 法语高频名词化 | Le numérique transforme le monde du travail. |
| les réseaux sociaux | n.m.pl. | social media | 社交媒体 | 永远复数 | Les réseaux sociaux influencent l'opinion publique. |
| l'intelligence artificielle (IA) | n.f. | artificial intelligence | 人工智能 | Tâche 3 当前热点 | L'intelligence artificielle suscite autant d'espoir que de crainte. |
| le mot de passe | n.m. | password | 密码 | 生活场景 | J'ai oublié mon mot de passe. |
| se connecter / la connexion | v./n.f. | to log in / connection | 登录/连接 | 技术场景 | Je n'arrive pas à me connecter à mon compte. |
| en ligne / hors ligne | loc. | online / offline | 在线/离线 | 办事高频 | La demande se fait entièrement en ligne. |
| télécharger | v. | to download | 下载 | 技术基础词 | Téléchargez le formulaire sur le site. |
| la protection des données | n.f. | data protection | 数据保护 | 隐私议题 | La protection des données personnelles inquiète les usagers. |
| la fraude / l'hameçonnage | n.f./n.m. | fraud / phishing | 诈骗/钓鱼 | 魁北克用 hameçonnage 代替 phishing | Méfiez-vous des courriels d'hameçonnage. |
| la désinformation / les fausses nouvelles | n.f. | disinformation / fake news | 虚假信息 | 魁北克说 fausses nouvelles | La désinformation se propage vite en ligne. |
| le temps d'écran | n.m. | screen time | 屏幕使用时间 | 健康与教育议题 | Le temps d'écran des adolescents inquiète les parents. |
| la fracture numérique | n.f. | digital divide | 数字鸿沟 | 社会议题高分词 | La fracture numérique touche les aînés et les régions. |
| l'automatisation | n.f. | automation | 自动化 | 就业议题 | L'automatisation menace certains emplois. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| la réservation / réserver une table | n.f./v. | reservation / to book a table | 订位 | EO2 角色扮演高频 | J'aimerais réserver une table pour six personnes. |
...
| l'entrée / le plat principal / le dessert | n.f./n.m. | starter / main course / dessert | 前菜/主菜/甜点 | 注意 entrée 在法语是前菜 | En entrée, je prendrai une soupe. |
| la végétarien(ne) / végétalien(ne) | adj. | vegetarian / vegan | 素食的/纯素的 | 饮食议题 | Je suis végétarien depuis cinq ans. |
| l'allergie / être allergique à | n.f./loc. | allergy / to be allergic to | 过敏 | 点餐必备 | Je suis allergique aux arachides. |

### 天气

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| la météo / les prévisions | n.f. | weather / forecast | 天气/预报 | CO 广播题高频 | Selon la météo, il va neiger demain. |
| il fait froid / doux / humide | loc. | it is cold / mild / humid | 天气冷/温和/潮湿 | il fait 是固定结构 | Il fait moins quinze ce matin. |
| la pluie / la neige / le vent | n.f./n.m. | rain / snow / wind | 雨/雪/风 | 基础天气词 | La neige commencera en soirée. |
| l'avertissement météorologique | n.m. | weather warning | 天气预警 | 加拿大广播固定用语 | Un avertissement de tempête est en vigueur. |
...
| faire du bénévolat / du sport / de la randonnée | v. | to volunteer / do sport / go hiking | 做志愿/运动/徒步 | faire de + 活动 结构 | Je fais de la randonnée les fins de semaine. |
| la bibliothèque | n.f. | library | 图书馆 | 社区资源，非 librairie 书店 | La bibliothèque offre des ateliers gratuits. |
| le centre communautaire | n.m. | community centre | 社区中心 | 加拿大社区生活核心 | Le centre communautaire propose des cours de français. |
| l'inscription à une activité | n.f. | activity registration | 活动报名 | EO2 场景 | L'inscription se fait en ligne avant le 30 août. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| s'occuper de | v. | to take care of / to handle | 负责/照料 | 介词 de，高频 | Je m'occupe de la réservation. |
| se rendre compte de / que | v. | to realise | 意识到 | 反身动词，高分 | Je me suis rendu compte que j'avais oublié. |
| réussir à + 原形 | v. | to manage to | 成功做到 | 介词 à | J'ai réussi à obtenir un rendez-vous. |
| arriver à + 原形 | v. | to manage to | 做得到 | 口语版 réussir à | Je n'arrive pas à comprendre cette règle. |
...
| se plaindre de | v. | to complain about | 抱怨 | 投诉场景 | Les voisins se plaignent du bruit. |
| profiter de | v. | to take advantage of / to enjoy | 利用/享受 | 正面含义 | Profitez de l'offre avant la fin du mois. |
| participer à | v. | to take part in | 参加 | 介词 à | J'ai participé à un atelier d'emploi. |
| convenir à / convenir de | v. | to suit / to agree on | 适合/商定 | 双用法 | Cette date me convient parfaitement. |

### 高频动词

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| constater | v. | to observe / to note | 发现/注意到 | 书面高分 | J'ai constaté une erreur sur ma facture. |
| signaler | v. | to report / to flag | 反映/报告 | 投诉高分动词 | Je souhaite signaler un problème récurrent. |
| régler | v. | to settle / to fix | 解决/付清 | 一词两义 | J'espère que ce problème sera réglé rapidement. |
| joindre | v. | to reach (someone) / to attach | 联系上/附上 | 双义高频 | Vous pouvez me joindre au numéro suivant. |
| renseigner / se renseigner | v. | to inform / to find out | 告知/打听 | EO2 核心动词 | Je me suis renseigné auprès de la mairie. |
| favoriser | v. | to promote / to encourage | 促进 | 议论高分动词 | Le télétravail favorise l'autonomie. |
| renforcer | v. | to strengthen | 加强 | 议论高分动词 | Il faut renforcer les services publics. |
| réduire / diminuer | v. | to reduce / to decrease | 减少 | 数据与政策 | Cette mesure vise à réduire les coûts. |
| augmenter / accroître | v. | to increase | 增加 | accroître 更书面 | Le nombre de demandes a fortement augmenté. |
...
| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| assister à | v. | to attend (NOT to assist) | 出席（不是协助） | 中英法三方易错，assist 是 aider | J'assiste au cours, je n'aide pas le professeur. |
| actuellement | adv. | currently (NOT actually) | 目前（不是实际上） | actually 是 en fait | Actuellement, je cherche un emploi. |
| éventuellement | adv. | possibly (NOT eventually) | 可能（不是最终） | eventually 是 finalement | Je pourrai éventuellement vous aider. |
| sensible | adj. | sensitive (NOT sensible) | 敏感的（不是明智的） | sensible 英文对应 raisonnable | C'est un sujet sensible. |
| la librairie | n.f. | bookshop (NOT library) | 书店（不是图书馆） | library 是 bibliothèque | J'ai acheté ce livre à la librairie. |
| le collège | n.m. | middle school (in France) / college (in Quebec) | 初中/学院 | 魁北克与法国含义不同，考点 | Au Québec, le cégep vient après le secondaire. |
| passer un examen | v. | to sit an exam (NOT to pass) | 参加考试（不是通过） | 通过是 réussir un examen | J'ai passé le TCF en mars et je l'ai réussi. |
| la monnaie | n.f. | change / currency (NOT money) | 零钱/货币 | money 是 l'argent | Gardez la monnaie. |
| demander | v. | to ask (NOT to demand) | 询问/请求 | demand 是 exiger | Je vous demande de patienter. |

### 语法陷阱

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| les / des 在形容词前 | det. | de before adjective+noun | 形容词前 des 变 de | de nombreux, de bonnes — 高分细节 | Il y a de nombreux avantages. |
| 虚拟式触发词 | gram. | subjunctive triggers | 虚拟式触发 | il faut que, bien que, pour que, avant que, vouloir que | Il faut que je parte maintenant. |
| 直陈式触发词 | gram. | indicative triggers | 直陈式触发 | parce que, puisque, après que, espérer que | J'espère que vous allez bien. |
| 复合过去时助动词 | gram. | avoir vs être | 助动词选择 | DR MRS VANDERTRAMP 动词和所有反身动词用 être | Je me suis inscrit hier. |
| 未完成过去时 vs 复合过去时 | gram. | imparfait vs passé composé | 背景描写 vs 具体动作 | Tâche 2 叙事的核心语法得分点 | Il pleuvait quand je suis sorti. |
| 条件式表礼貌 | gram. | conditional for politeness | 条件式表礼貌 | je voudrais / pourriez-vous / j'aimerais — EO2 必用 | Je voudrais réserver une place. |
| 性数一致 | gram. | gender and number agreement | 性数配合 | 形容词与过去分词的配合是 EE 高频扣分点 | Les décisions ont été prises hier. |

## COCE · CO/CE 公告、小广告与正式文件体

### 公告用语

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| veuillez + 原形 | expr. | please (formal imperative) | 请…… | 公告与通知的固定开头，CO 高频 | Veuillez patienter quelques instants. |
| nous vous informons que | expr. | we inform you that | 兹通知 | 正式通知开场 | Nous vous informons que le service sera interrompu. |
| en raison de | loc. | due to | 由于 | 公告说明原因的标准用语 | En raison de travaux, l'accès est fermé. |
| à compter du / à partir du | loc. | as of / starting from | 自……起 | 生效日期表达 | À compter du 1er juin, les tarifs changent. |
| jusqu'à nouvel ordre | loc. | until further notice | 另行通知前 | 公告固定语 | Le stationnement est interdit jusqu'à nouvel ordre. |
| est susceptible de | expr. | is likely to / may | 可能会 | 正式预警表达 | Le service est susceptible d'être retardé. |
| il est interdit de / défense de | expr. | it is forbidden to | 禁止 | 标识与规章 | Il est interdit de fumer dans l'immeuble. |
| il est obligatoire de | expr. | it is compulsory to | 必须 | 规章用语 | Il est obligatoire de présenter une pièce d'identité. |
| sous réserve de | loc. | subject to | 以……为条件 | 正式文件高频 | Offre valable sous réserve de disponibilité. |
| dans les plus brefs délais | loc. | as soon as possible | 尽快 | 正式催办 | Veuillez répondre dans les plus brefs délais. |
| prière de | expr. | kindly | 敬请 | 标识用语 | Prière de ne pas déranger. |
| le préavis | n.m. | advance notice | 提前通知期 | 与劳动合同的 préavis 同词不同语境，此处指规章要求的提前告知 | Un préavis de trente jours est exigé pour résilier le bail. |
| entrer en vigueur | expr. | to come into effect | 生效 | 政策公告 | La nouvelle règle entre en vigueur lundi. |
| être en vigueur | expr. | to be in force | 现行有效 | 加拿大公告高频 | Un avertissement de chaleur est en vigueur. |

### 小广告

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| à louer / à vendre | loc. | for rent / for sale | 出租/出售 | petite annonce 标题词 | Quatre et demi à louer, libre immédiatement. |
| libre immédiatement | loc. | available immediately | 即刻可入住 | 租房广告 | Logement libre immédiatement, non meublé. |
| tout inclus / tout compris | loc. | all inclusive | 全包 | 租房与旅游广告 | Loyer de 1 200 dollars, tout inclus. |
| proche de / à deux pas de | loc. | close to / a stone's throw from | 靠近 | 广告卖点表达 | À deux pas du métro et des commerces. |
| s'adresser à / contacter | v. | to contact | 请联系 | 广告结尾 | S'adresser au concierge pour visiter. |
| références exigées | loc. | references required | 需提供推荐人 | 租房广告条件 | Références exigées, non-fumeur. |
| expérience souhaitée / exigée | loc. | experience preferred / required | 经验优先/必备 | 招聘广告 | Expérience exigée : deux ans minimum. |
| faire parvenir votre CV | expr. | to send in your CV | 请投递简历 | 招聘广告结尾 | Faire parvenir votre CV avant le 15 mai. |
| poste à combler | n.m. | position to be filled | 待招职位 | 加拿大招聘用语 | Poste à combler immédiatement. |
| temps plein / temps partiel | loc. | full-time / part-time | 全职/兼职 | 招聘广告 | Poste à temps partiel, soirs et fins de semaine. |

### 正式文件

| français | 词性 | English | 中文 | 用法要点 | exemple |
|---|---|---|---|---|---|
| le formulaire | n.m. | form | 表格 | 办事流程 | Remplissez le formulaire en ligne. |
| remplir / déposer une demande | v. | to fill out / to submit an application | 填写/提交申请 | 流程动词 | J'ai déposé ma demande la semaine dernière. |
| la pièce justificative | n.f. | supporting document | 证明文件 | 官方文件高频 | Joignez toutes les pièces justificatives. |
| la pièce d'identité | n.f. | photo ID | 身份证件 | 办事必备 | Présentez une pièce d'identité avec photo. |
| la preuve de résidence | n.f. | proof of address | 居住证明 | 办事必备 | Une preuve de résidence est requise. |
| le délai de traitement | n.m. | processing time | 办理时长 | 移民与办事高频 | Le délai de traitement est de huit semaines. |
| être admissible à | expr. | to be eligible for | 符合……资格 | 加拿大说 admissible，法国说 éligible | Vous êtes admissible à cette subvention. |
| le renouvellement / renouveler | n.m./v. | renewal / to renew | 续期 | 证件与租约 | Le renouvellement du permis se fait en ligne. |
| échoir / la date d'expiration | v./n.f. | to expire / expiry date | 到期 | 证件管理 | Vérifiez la date d'expiration de votre carte. |
| les frais de dossier | n.m.pl. | application fee | 申请费 | 办事费用 | Les frais de dossier sont non remboursables. |
| le reçu / l'accusé de réception | n.m. | receipt / acknowledgement of receipt | 收据/收讫回执 | 正式流程 | Vous recevrez un accusé de réception par courriel. |
