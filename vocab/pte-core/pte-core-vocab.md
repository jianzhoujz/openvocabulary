...
| Dear + 名 | chunk | 亲爱的…… | 半正式（同事、熟识客户）。PTE 题干给了名字就用这个 | Dear Michael, |
| Hi + 名 | chunk | 嗨，…… | 非正式（朋友、邻居）。题干是朋友/邻居场景时用，用错 register 扣 appropriacy | Hi Sarah, |
...
| Please find attached | chunk | 附件请查收 | 邮件公约用语，PTE 明确考 email conventions | Please find attached a copy of the receipt. |
...
| on three separate occasions | chunk | 前后三次 | 量化投诉，增加 content 分 | I have raised this issue on three separate occasions. |
...
| compensation | n. | 赔偿 | 不可数，不加 s | We are prepared to offer compensation. |
...
| If this is not convenient, please let me know | chunk | 如不方便请告知 | 体贴收尾，得 appropriacy 分 | If this is not convenient, please let me know. |
...
## RTS · Respond to a Situation 口语应答
...
| Let me make it up to you | idm | 让我补偿你 | 道歉后提补救，得 appropriacy 分 | Let me make it up to you — coffee's on me. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| If I were you, I'd | chunk | 我要是你，我会 | 虚拟语气建议句，考官爱听的语法点 | If I were you, I'd speak to the supervisor directly. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| I don't mean to complain, but | chunk | 我不是想抱怨，但是 | 软化投诉开场，保住 appropriacy | I don't mean to complain, but the heating still isn't working. |
...
## DI · Describe Image 图表与图片描述

### 图表类型

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| bar chart / bar graph | n. | 柱状图 | 开场一句必须报图型，漏了扣 content 分 | The bar chart compares sales across four regions. |
...
| table | n. | 表格 | 配 row/column | The table presents figures for five product lines. |
| floor plan / map | n. | 平面图/地图 | PTE Core 常考建筑平面与社区地图 | The map shows the layout of the community centre. |
| poster / flyer | n. | 海报/传单 | Core 特有的生活类图片，要读出标题和关键信息 | The poster advertises a free vaccination clinic. |
| the x-axis / the y-axis | n. | 横轴/纵轴 | 说明坐标含义 | The x-axis represents years and the y-axis shows revenue in dollars. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| rise / increase / grow | v. | 上升 | 最基础，务必搭配副词避免重复 | Sales rose steadily throughout the year. |
| climb | v. | 攀升 | rise 的替换词 | Attendance climbed to 4,000 in June. |
| surge | v. | 激增 | 剧烈上升 | Demand surged after the announcement. |
| soar | v. | 飙升 | 最强烈的上升 | House prices soared by 30 percent. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| fall / decline / decrease | v. | 下降 | 基础词 | Enrolment fell sharply after 2018. |
| drop | v. | 下跌 | 口语化，读图常用 | The figure dropped to just 12 percent. |
| plummet | v. | 暴跌 | 极剧烈下降，高分词 | Profits plummeted in the second half. |
| dip | v./n. | 小幅回落 | 短暂下降 | There was a slight dip in March. |
...
| plateau | v./n. | 进入平台期 | 高分词 | The trend plateaued after 2015. |
| fluctuate | v. | 波动 | 上下起伏 | Temperatures fluctuated between 5 and 15 degrees. |

### 趋势-副词

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| sharply / dramatically | adv. | 急剧地 | 修饰剧烈变化 | Costs rose dramatically in one year. |
| steadily / gradually | adv. | 稳步/逐渐地 | 修饰平缓变化 | Membership grew steadily over the decade. |
| slightly / marginally | adv. | 略微地 | 小幅变化 | Output fell marginally in the last month. |
| significantly / considerably | adv. | 显著地 | 通用强化词 | Waiting times decreased considerably. |

### 极值比较

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| the highest / the peak | n. | 最高点/峰值 | 必说极值，是 content 得分点 | Sales reached a peak of 8,000 units in July. |
...
| outnumber | v. | 数量超过 | 比较两组 | Female participants outnumbered male participants. |
...
| whereas / while | conj. | 而 | 对比连接词，写作口语通用 | Sales grew in the north, whereas they fell in the south. |

### 收尾

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| Overall, it is clear that | chunk | 总体而言，显然 | 结尾句必说，是评分点 | Overall, it is clear that demand has risen over the period. |

## SUM · Summarize Written/Spoken Text 概括与连接
...
| highlight | v. | 强调 | 中性概括 | The article highlights the shortage of skilled workers. |
| outline | v. | 概述 | 介绍框架 | The passage outlines three approaches to the problem. |
| emphasise | v. | 强调 | 与 highlight 轮换 | The speaker emphasised the need for early intervention. |
...
| propose | v. | 提出（方案） | 建议类 | The author proposes a phased rollout. |
| examine / explore | v. | 探讨 | 中性引出主题 | The text examines the causes of urban sprawl. |

### 概括名词

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| findings | n. | 研究结果 | 复数形式，SST 高频 | The findings suggest a strong link between the two. |
| implications | n. | 影响/意义 | 结尾常用 | The implications for small businesses are significant. |
| drawbacks | n. | 弊端 | 对比优缺点 | Despite the drawbacks, the scheme has proved popular. |
| factors | n. | 因素 | 万能概括名词 | Several factors contributed to the outcome. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| moreover / furthermore | adv. | 此外 | 正式递进 | Furthermore, the scheme reduced waiting times. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| however / nevertheless | adv. | 然而/尽管如此 | 最常用转折，注意标点 | The plan was approved; however, funding was delayed. |
...
| therefore / thus | adv. | 所以 | 正式因果 | The data is limited; therefore, the results are tentative. |
...
| vacancy / opening | n. | 空缺职位 | opening 更口语，北美常用 | There is an opening in the finance team. |
| résumé / CV | n. | 简历 | 北美用 résumé，CV 指学术长简历 | Please attach your résumé and a cover letter. |
...
| shortlist | v./n. | 入围名单 | 被选入面试 | Only five applicants were shortlisted. |
| job interview | n. | 面试 | 固定搭配，不说 job test | I have a job interview on Tuesday morning. |
| qualifications | n. | 资历/学历 | 通常复数 | She has the qualifications required for the role. |
| credentials | n. | 资质证明 | 加拿大移民语境高频（外国学历认证） | Foreign credentials must be assessed before you can practise. |
| references | n. | 推荐人 | 北美求职必备 | Please provide two professional references. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| full-time / part-time | adj. | 全职/兼职 | 连字符不能少 | This is a full-time permanent position. |
| permanent / temporary | adj. | 长期/临时的 | 合同类型 | The contract is temporary, ending in December. |
| shift work | n. | 轮班工作 | 加拿大蓝领岗位高频 | The job involves shift work, including nights. |
| overtime | n. | 加班（费） | 不可数 | Overtime is paid at 1.5 times the regular rate. |
| salary / wage | n. | 薪水/工资 | salary 按年，wage 按小时 | The starting wage is $22 an hour. |
| benefits package | n. | 福利待遇包 | 北美求职核心词 | The benefits package includes dental and vision coverage. |
| paid leave | n. | 带薪假 | PTE 邮件题高频 | Employees are entitled to ten days of paid leave. |
| sick leave | n. | 病假 | 固定搭配 | I need to take sick leave for two days. |
| parental leave | n. | 育儿假 | 加拿大特色福利（男女通用） | She is on parental leave until August. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| colleague / coworker | n. | 同事 | coworker 北美更常用 | I discussed it with a coworker. |
| supervisor / line manager | n. | 直属上司 | PTE 邮件常见收件人 | Please copy your supervisor on the email. |
| staff | n. | 员工（集体） | 集体名词，不加 s，不说 a staff | All staff are required to attend. |
| workload | n. | 工作量 | 高频抱怨/协商词 | My workload has increased significantly. |
| deadline | n. | 截止期限 | meet/miss/extend a deadline | We are on track to meet the deadline. |
...
| timesheet | n. | 工时表 | 时薪制职场必备 | Timesheets must be submitted weekly. |

### 会议项目

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| agenda | n. | 议程 | meeting 固定搭配 | I've attached the agenda for tomorrow's meeting. |
| minutes | n. | 会议纪要 | 复数形式才是这个意思 | Could you take the minutes today? |
| reschedule | v. | 改期 | PTE 邮件高频动词 | We need to reschedule the meeting to Thursday. |
...
| attend | v. | 出席 | 及物动词，不加 to | I will be unable to attend the session. |
...
| milestone | n. | 里程碑 | 项目管理词 | We have reached the first milestone. |
| deliverable | n. | 交付成果 | 项目词，常复数 | All deliverables are due next Friday. |
| stakeholder | n. | 利益相关方 | 项目沟通高频 | We need to inform all stakeholders. |
...
| delegate | v. | 把工作分派给 | 管理动词 | She delegated the reporting to her assistant. |
| prioritise | v. | 按优先级处理 | 职场高频 | We need to prioritise the client's request. |
...
| feedback | n. | 反馈 | 不可数，不说 feedbacks | I'd welcome any feedback on the draft. |
| promotion | n. | 晋升 | get/be up for a promotion | Congratulations on your promotion! |
| raise (US) / pay rise (UK) | n. | 加薪 | 加拿大用 raise | She asked for a raise at her review. |
| professional development | n. | 职业发展培训 | 福利类高频 | The company funds professional development courses. |
| upskill | v. | 提升技能 | 现代职场热词 | Staff were encouraged to upskill in data tools. |
| mentor | n./v. | 导师/指导 | 职场支持体系 | A senior engineer mentored me for six months. |
...
| dismiss / fire | v. | 解雇 | 因过错辞退，fire 口语 | He was dismissed for repeated lateness. |
| grievance | n. | 申诉 | 正式投诉程序 | She filed a formal grievance with HR. |
| harassment | n. | 骚扰 | 加拿大职场法规高频 | The company has a zero-tolerance policy on harassment. |
| discrimination | n. | 歧视 | 人权法语境 | Discrimination on the basis of age is prohibited. |
| burnout | n. | 职业倦怠 | 现代职场热词 | Long hours can lead to burnout. |
...
| health and safety | n. | 职业健康与安全 | 加拿大工作场所法定术语 | All staff must complete health and safety training. |
...
| commute | n./v. | 通勤 | 与远程办公对比 | My commute takes about an hour each way. |
| self-employed / freelance | adj. | 自雇/自由职业 | 加拿大报税语境高频 | I have been self-employed for three years. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| landlord / landlady | n. | 房东 | PTE Core 邮件题超高频收件人 | I emailed the landlord about the leak. |
| tenant | n. | 租客 | 与 landlord 成对 | Tenants must give 60 days' notice. |
| lease / tenancy agreement | n. | 租约 | sign/renew/break a lease | My lease expires at the end of June. |
| rent | n./v. | 房租/租用 | 不可数；pay rent 不加 the | The rent is due on the first of each month. |
| security deposit | n. | 押金 | 加拿大多为 last month's rent | The security deposit will be returned within ten days. |
| utilities | n. | 水电煤等公用事业费 | 租房广告核心词，永远用复数 | Rent is $1,600 including utilities. |
| hydro | n. | 电费（加拿大用法） | 加拿大特有：electricity 叫 hydro | Hydro is not included in the rent. |
| superintendent / super | n. | 楼管/管理员 | 加拿大公寓特有称呼 | Please contact the building superintendent. |
| property manager | n. | 物业经理 | 投诉邮件常见对象 | I have reported the issue to the property manager twice. |
| sublet | v./n. | 转租 | 租房合规问题 | Subletting requires written permission. |
| move in / move out | pv | 搬入/搬出 | 固定搭配 | We are moving in on the first of August. |
| furnished / unfurnished | adj. | 带家具/不带家具的 | 租房广告必读词 | The unit is partially furnished. |
| one-bedroom unit | n. | 一居室 | 北美房源标准说法 | We are looking for a one-bedroom unit downtown. |
| bachelor apartment / studio | n. | 开间公寓 | bachelor 是加拿大特有说法 | A bachelor apartment rents for around $1,200. |

### 维修

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| leak | n./v. | 漏水 | 维修邮件最高频问题 | There is a leak under the kitchen sink. |
| clogged / blocked drain | n. | 下水道堵塞 | 常见报修 | The bathroom drain has been clogged since Monday. |
| faulty | adj. | 有故障的 | 正式描述设备问题 | The smoke detector appears to be faulty. |
| out of order | phr | 无法使用 | 公共设施故障 | The elevator has been out of order for three days. |
| repair / fix | v./n. | 维修 | repair 正式，fix 口语 | The repairs were completed the same day. |
| maintenance request | n. | 报修申请 | 租房流程术语 | I submitted a maintenance request online. |
| heating / furnace | n. | 暖气/炉子 | 加拿大冬天核心报修词 | The furnace stopped working overnight. |
| air conditioning | n. | 空调 | 常缩写 AC | The air conditioning is not cooling properly. |
| plumbing | n. | 管道系统 | 不可数 | The building has ongoing plumbing problems. |
| wear and tear | idm | 正常磨损 | 押金纠纷关键概念 | Normal wear and tear is not deducted from the deposit. |
| infestation | n. | 虫害 | 严重报修理由 | There has been a pest infestation on the third floor. |

### 购房

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| mortgage | n. | 按揭贷款 | 加拿大置业核心词 | We were pre-approved for a mortgage. |
| down payment | n. | 首付 | 北美说法，不用 deposit | The minimum down payment is five percent. |
| property tax | n. | 房产税 | 加拿大房主年度支出 | Property taxes are billed by the municipality. |
...
| condo fees | n. | 公寓管理费 | 加拿大 condo 特有 | Condo fees cover the gym and the pool. |

### 社区

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| neighbour | n. | 邻居 | 加拿大用英式拼写 neighbour | My neighbour plays music late at night. |
| noise complaint | n. | 噪音投诉 | RTS 与邮件题高频场景 | I filed a noise complaint with the building office. |
...
| garbage / recycling / compost | n. | 垃圾/回收/厨余 | 加拿大三分类，compost 是特色 | Compost is collected every Tuesday. |
| curbside pickup | n. | 路边收运/路边取货 | 加拿大市政与零售通用词 | Recycling is placed at the curb for curbside pickup. |
| snow removal / shovelling | n. | 除雪/铲雪 | 加拿大冬季生活必备 | Snow removal is the tenant's responsibility. |
| community centre | n. | 社区中心 | 加拿大社区生活核心场所 | The community centre offers free language classes. |
| bylaw | n. | 市政条例 | 加拿大特有：municipal bylaw | A city bylaw prohibits noise after 11 p.m. |
...
| family doctor / GP | n. | 家庭医生 | 加拿大医疗体系入口，超高频 | It can take months to find a family doctor. |
| walk-in clinic | n. | 免预约诊所 | 加拿大特有就医方式 | I went to a walk-in clinic instead of the ER. |
| emergency room (ER) | n. | 急诊室 | 英国说 A and E，加拿大用 ER | The ER wait was over six hours. |
| referral | n. | 转诊单 | 加拿大看专科必须先有转诊 | You need a referral to see a specialist. |
| specialist | n. | 专科医生 | 与 family doctor 对应 | She was referred to a specialist. |
| prescription | n. | 处方 | fill a prescription 是去取药 | I need to renew my prescription. |
| pharmacy / drugstore | n. | 药房 | 加拿大两者通用 | The pharmacy is open until nine. |
| over-the-counter | adj. | 非处方的 | 与 prescription 相对 | Over-the-counter painkillers should be enough. |
| health card | n. | 医保卡 | 加拿大省级医保卡，如安省 OHIP 卡 | Remember to bring your health card. |
| coverage | n. | 保障范围 | 保险核心词，不可数 | Dental care is not covered by provincial health coverage. |
| extended health benefits | n. | 补充医疗福利 | 雇主提供，覆盖牙科视力 | My employer provides extended health benefits. |
| out-of-pocket | adj./adv. | 自费的 | 保险费用词 | I paid $40 out of pocket for the medication. |
| waiting list | n. | 轮候名单 | 加拿大医疗体系常见抱怨点 | He has been on a waiting list for surgery. |

### 症状

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| symptom | n. | 症状 | 描述病情基础词 | My symptoms started three days ago. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| well-being | n. | 身心健康 | 议论类高分词，连字符不能少 | The program supports employee well-being. |
| mental health | n. | 心理健康 | 加拿大社会议题高频 | There is growing awareness of mental health at work. |
...
| work out | pv | 健身锻炼 | PTE Core 健身房邮件题实际考过 | I work out three times a week. |
| cardio / strength training | n. | 有氧训练/力量训练 | 健身邮件题的三点式内容 | The class combines cardio and strength training. |
| screening | n. | 筛查 | 预防医学词 | Regular screening can detect problems early. |
| immunisation / vaccination | n. | 疫苗接种 | 社区公告高频 | A free vaccination clinic runs on Saturday. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| chequing account | n. | 支票账户 | 加拿大拼 cheque，不是美式 check | I opened a chequing account at a local branch. |
| savings account | n. | 储蓄账户 | 与 chequing 成对出现 | Interest is paid monthly on the savings account. |
| debit card | n. | 借记卡 | 加拿大 Interac 支付主力 | Most stores accept debit cards. |
| e-transfer | n. | 电子转账 | 加拿大特有的 Interac e-Transfer | I will send you the money by e-transfer. |
| direct deposit | n. | 工资直存 | 北美发薪标准方式 | Your pay will be made by direct deposit. |
| withdraw / deposit | v. | 取款/存款 | 基础银行动词 | You can withdraw up to $500 a day. |
| overdraft | n. | 透支 | 账户收费项 | The overdraft fee is $5 per occurrence. |
| interest rate | n. | 利率 | 固定搭配 | The interest rate has risen twice this year. |
| credit score | n. | 信用分 | 加拿大新移民必须尽早建立 | Paying bills on time improves your credit score. |
| RRSP / TFSA | n. | 注册退休储蓄计划/免税储蓄账户 | 加拿大特有账户，听力里会直接念缩写 | Contributions to an RRSP are tax-deductible. |
| paycheque | n. | 工资支票/工资 | 加拿大拼 paycheque | Deductions are listed on your paycheque. |

### 税务

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| income tax | n. | 所得税 | 加拿大每年四月报税 | Income tax returns are due by 30 April. |
...
| deduction | n. | 扣除项/扣款 | 工资条与报税双语境 | Childcare costs may qualify as a deduction. |
| GST / HST | n. | 商品服务税/统一销售税 | 加拿大标价不含税，结账才加 | The price does not include HST. |

### 账单消费

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| invoice | n. | 发票/账单 | 商务场景，PTE 邮件高频 | The invoice is attached for your records. |
| be due | phr | 到期应付 | 账单时间表达 | The payment is due on the 15th. |
| overdue | adj. | 逾期的 | 催款用语 | Your account is now 30 days overdue. |
| instalment | n. | 分期付款 | 加拿大拼 instalment 单 l | The cost can be paid in six monthly instalments. |
| receipt | n. | 收据 | 退货必需，p 不发音但要拼出来 | Please keep your receipt for the warranty. |
| warranty | n. | 保修 | 消费维权核心词 | The laptop is still under warranty. |
| refund | n./v. | 退款 | 投诉邮件的核心诉求 | I would like a full refund rather than a replacement. |
| exchange | n./v. | 换货 | 与 refund 并列给选项 | The store offered an exchange but not a refund. |
| reimbursement | n. | 报销 | 职场费用场景 | I submitted the receipts for reimbursement. |
| surcharge | n. | 附加费 | 隐藏收费投诉高频 | There is a surcharge for weekend delivery. |
| tip / gratuity | n. | 小费 | 北美生活必备，餐厅通常 15 到 20 个百分点 | A gratuity of 18 percent is added for large groups. |
| budget | n./v. | 预算/编制预算 | 职场与生活双高频 | The project came in under budget. |
| affordable | adj. | 负担得起的 | 住房议题高频 | The city needs more affordable housing. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| premium | n. | 保费 | 保险核心词，非 bonus | Car insurance premiums went up this year. |
| deductible | n. | 免赔额 | 北美保险特有概念 | The deductible on my policy is $500. |
| claim | n./v. | 索赔 | 动词搭配 file a claim | I filed a claim after the accident. |
| policy | n. | 保单 | 一词多义，也指政策 | Please review your policy before renewing. |
| liable / liability | adj./n. | 负有责任的/赔偿责任 | 保险与租房合同高频 | The landlord is not liable for tenants' belongings. |

### 社保福利

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| Employment Insurance (EI) | n. | 就业保险 | 加拿大特有：失业与产假都由它支付 | She applied for EI after being laid off. |
| Canada Pension Plan (CPP) | n. | 加拿大退休金计划 | 工资条必见的扣款项 | CPP contributions are deducted from every paycheque. |
| Social Insurance Number (SIN) | n. | 社会保险号 | 在加拿大工作的必备号码 | You need a SIN before you can start work. |
| Canada Child Benefit | n. | 儿童福利金（俗称牛奶金） | 加拿大家庭高频 | The Canada Child Benefit is paid monthly. |
| subsidy | n. | 补贴 | 托儿与住房补贴语境 | Low-income families may qualify for a childcare subsidy. |
...
| fare | n. | 车票费用 | 不说 ticket price | Transit fares will increase in January. |
| monthly pass | n. | 月票 | 通勤高频 | A monthly pass costs $156. |
| transfer | n./v. | 换乘/换乘票 | 北美公交特有概念 | Ask the driver for a transfer. |
| route | n. | 线路 | bus route / delivery route | The bus route was changed last month. |
...
| detour | n. | 绕行 | 施工通告高频 | A detour is in place while the bridge is repaired. |
| accessible | adj. | 无障碍的 | 加拿大公共设施法定用词 | All stations are wheelchair accessible. |

### 驾车

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| driver's licence | n. | 驾照 | 加拿大拼 licence 名词，license 动词 | You need a valid driver's licence to rent a car. |
| insurance | n. | 保险 | 驾车必备，不可数 | Proof of insurance must be kept in the vehicle. |
| parking ticket | n. | 违停罚单 | 与 parking spot 区分 | I got a parking ticket downtown. |
| speeding | n. | 超速 | 交通违规 | He was fined for speeding. |
| winter tires | n. | 冬季轮胎 | 加拿大魁北克法定要求，特色词 | Winter tires are mandatory in Quebec from December. |
| carpool / rideshare | n./v. | 拼车 | 环保与通勤议题 | Several colleagues carpool to work. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| book / reserve | v. | 预订 | book 英式常用，reserve 通用 | I have booked a table for eight. |
| confirmation number | n. | 确认号 | 预订邮件必备信息 | Please quote your confirmation number. |
| itinerary | n. | 行程安排 | 拼写易错 | I have attached the full itinerary. |
| accommodation | n. | 住宿 | 英式不可数，北美常用复数 accommodations | Accommodation will be arranged for out-of-town guests. |
...
| customs | n. | 海关 | 永远复数 | You must declare food items at customs. |
| cancellation policy | n. | 取消政策 | 预订纠纷核心 | Their cancellation policy requires 48 hours' notice. |
| refundable / non-refundable | adj. | 可退/不可退的 | 预订投诉高频 | The deposit is non-refundable. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| school board | n. | 教育局 | 加拿大特有的地区教育管理机构 | The school board announced a snow day. |
| tuition | n. | 学费 | 不可数，不加 s | Tuition has increased by four percent. |
| enrol / enrolment | v./n. | 注册/入学人数 | 加拿大拼 enrol 单 l | Enrolment in the program has doubled. |
| semester / term | n. | 学期 | 北美通用 | The course runs over two semesters. |
| credential evaluation | n. | 学历认证 | 加拿大移民与就业必经流程 | Your degree requires a credential evaluation. |
| transcript | n. | 成绩单 | 申请必备文件 | Please send an official transcript. |
| prerequisite | n. | 先修课程 | 选课高频 | Statistics is a prerequisite for this course. |
| assignment | n. | 作业/任务 | PTE 邮件题考过找教授延期 | The assignment is due next Monday. |
| extension | n. | 延期 | request an extension 固定搭配 | Could I request a short extension on the deadline? |
| scholarship / bursary | n. | 奖学金/助学金 | bursary 按需发放，加拿大常用 | She received a bursary based on financial need. |

### 培训

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| workshop | n. | 工作坊 | 社区与职场培训高频 | The library runs a free résumé workshop. |
| certification | n. | 资格认证 | 职业准入 | Forklift certification is required for this role. |
| apprenticeship | n. | 学徒制 | 加拿大技工路径核心词 | He completed a four-year apprenticeship as an electrician. |
| continuing education | n. | 继续教育 | 成人学习高频 | Continuing education courses run in the evenings. |
| settlement services | n. | 新移民安置服务 | 加拿大特有，免费语言与就业支持 | Settlement services help newcomers find work. |
| LINC classes | n. | 新移民语言培训班 | 加拿大特有免费英语课程 | She attends LINC classes twice a week. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| customer service | n. | 客户服务 | PTE Core 邮件题核心场景 | I contacted customer service about the order. |
| inquiry / enquiry | n. | 咨询 | 北美 inquiry，英式 enquiry，都接受 | Thank you for your inquiry. |
| order number | n. | 订单号 | 投诉邮件必须给出的细节 | My order number is 48219. |
| place an order | chunk | 下单 | 动词固定用 place | I placed the order on 3 March. |
| process | v. | 处理 | 订单与申请通用 | Your request is being processed. |
| dispatch / ship | v. | 发货 | 物流环节 | The item was dispatched on Tuesday. |
| delivery / shipment | n. | 配送/发货批次 | 投诉高频 | The delivery arrived a week late. |
...
| backorder | n. | 缺货待发 | 北美零售术语 | The product is on backorder until June. |
| defective / damaged | adj. | 有缺陷的/损坏的 | 投诉邮件描述问题 | The unit arrived damaged. |
| replacement | n. | 替换品 | 与 refund 并列的解决方案 | We will send a replacement free of charge. |
...
| escalate | v. | 上报升级 | 投诉流程词 | I would like to escalate this complaint. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| Service Canada | n. | 加拿大服务部 | 办 SIN、EI 的联邦机构，听力常提 | You can apply in person at a Service Canada centre. |
| municipality / city hall | n. | 市政府/市政厅 | 地方政府 | The municipality provides snow removal. |
| province / provincial | n./adj. | 省/省级的 | 加拿大三级政府核心概念 | Health care is a provincial responsibility. |
| federal | adj. | 联邦的 | 与 provincial 对照 | Immigration is a federal matter. |
...
| renew | v. | 续期 | 证件与租约通用 | I need to renew my permit before it expires. |
| expire / expiry date | v./n. | 到期/到期日 | 加拿大用 expiry，美式 expiration | Check the expiry date on your card. |

### 移民身份

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| permanent resident (PR) | n. | 永久居民 | 移民核心身份 | She became a permanent resident last year. |
| citizenship | n. | 公民身份 | 入籍语境 | You can apply for citizenship after three years. |
| work permit | n. | 工作许可 | 临时身份 | His work permit is valid for two years. |
| newcomer | n. | 新移民 | 加拿大官方用语，比 immigrant 中性友好 | The centre offers programs for newcomers. |
| sponsor | v./n. | 担保 | 家庭团聚移民 | He sponsored his parents for permanent residence. |

### 社会议题

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| multiculturalism | n. | 多元文化主义 | 加拿大国策，议论题高频 | Multiculturalism is often described as a Canadian value. |
| inclusion / inclusive | n./adj. | 包容/包容的 | 加拿大公共话语核心词 | The policy aims to create an inclusive workplace. |
| Indigenous peoples | n. | 原住民 | 加拿大必须掌握的正确表述，首字母大写 | The land acknowledgement recognises Indigenous peoples. |
| volunteer | n./v. | 志愿者/做志愿 | 加拿大社区生活与简历高频 | I volunteer at the food bank on weekends. |
| food bank | n. | 食物银行 | 加拿大社区互助机构 | Donations to the food bank rise in winter. |
| charity / fundraiser | n. | 慈善机构/募捐活动 | 社区活动邮件题高频 | The school is holding a fundraiser next month. |
| homelessness | n. | 无家可归问题 | 城市议题 | The city has expanded shelters to address homelessness. |
| affordability crisis | n. | 可负担性危机 | 加拿大当前头号议题 | The housing affordability crisis dominates the debate. |
...
| glitch | n. | 小故障 | 口语化技术问题 | A glitch in the system delayed the payments. |
| crash | v./n. | 崩溃 | 设备与软件 | The application keeps crashing. |
...
| upgrade | v./n. | 升级 | 与 update 区分：upgrade 换更好的 | We upgraded to the latest version. |
| subscription | n. | 订阅 | 消费投诉高频 | I would like to cancel my subscription. |
| troubleshoot | v. | 排查故障 | 客服与 IT 用词 | The technician helped me troubleshoot the issue. |
| user-friendly | adj. | 易用的 | 评价产品高分词 | The new interface is far more user-friendly. |
| privacy / data breach | n. | 隐私/数据泄露 | 社会议题 | The company reported a data breach. |
| scam / phishing | n. | 诈骗/钓鱼邮件 | 加拿大公共提醒高频 | Be alert to phishing emails asking for your SIN. |
| artificial intelligence (AI) | n. | 人工智能 | 议论题热点 | AI is reshaping many industries. |
| automation | n. | 自动化 | 就业议题 | Automation has reduced the need for manual tasks. |
...
| misinformation | n. | 错误信息 | 媒体议题高分词 | Misinformation spreads quickly online. |
| streaming | n. | 流媒体 | 娱乐消费 | Streaming services have replaced cable TV. |
...
| emissions | n. | 排放 | 常复数 | The plan aims to cut emissions by half. |
| renewable energy | n. | 可再生能源 | solar, wind, hydro | Canada generates much of its power from renewable energy. |
| sustainable / sustainability | adj./n. | 可持续的/可持续性 | 高分抽象名词 | The company has a sustainability policy. |
| single-use plastic | n. | 一次性塑料 | 加拿大已立法禁用，时事热点 | Single-use plastics have been banned nationwide. |
| landfill | n. | 垃圾填埋场 | 废弃物议题 | Composting keeps waste out of landfills. |
| conservation | n. | 保护/节约 | 自然与能源双用 | Water conservation measures apply in summer. |
| wildfire | n. | 野火 | 加拿大近年重大议题 | Wildfire smoke affected air quality across the province. |
| extreme weather | n. | 极端天气 | 气候议题 | Extreme weather events have become more frequent. |
| initiative | n. | 倡议/举措 | 社区与公司项目通用 | The city launched a tree-planting initiative. |
...
| sort out | pv | 解决/理顺 | 英式口语，加拿大也常用 | We need to sort out the scheduling problem. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| a significant increase | chunk | 显著增长 | Describe Image 必备 | There was a significant increase in demand. |
...
## DICT · Write from Dictation 拼写易错

### 拼写易错

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| accommodation | n. | 住宿 | 双 c 双 m，WfD 最经典陷阱词 | Student accommodation is limited this year. |
| recommend | v. | 推荐 | 双 m 单 c，与 accommodation 反着记 | I would recommend booking early. |
| necessary | adj. | 必要的 | 单 c 双 s，口诀 one collar two sleeves | It is necessary to register in advance. |
| separate | adj./v. | 分开的 | 中间是 a 不是 e，par 不是 per | Please submit separate applications. |
| definitely | adv. | 确实 | 中间是 finite，没有 a | The deadline has definitely been extended. |
| occurred / occurrence | v./n. | 发生 | 双 c 双 r | The error occurred during processing. |
| committee | n. | 委员会 | 双 m 双 t 双 e | The committee meets on Wednesdays. |
| equipment | n. | 设备 | 不可数，绝不加 s | The laboratory equipment was replaced. |
| environment | n. | 环境 | 中间的 n 容易漏掉 | The department studies the environment. |
| government | n. | 政府 | 中间的 n 容易漏掉 | The government announced new funding. |
| maintenance | n. | 维护 | 动词 maintain 但名词是 mainten- | Routine maintenance is scheduled for Sunday. |
| schedule | n./v. | 日程/安排 | 北美读 sked-，英式读 shed-，拼法相同 | The schedule has been revised. |
| questionnaire | n. | 问卷 | 双 n，结尾 -aire | Please complete the questionnaire online. |
| bureaucracy | n. | 官僚机构 | bureau + cracy | Students complain about university bureaucracy. |
| curriculum | n. | 课程体系 | 复数 curricula | The curriculum is reviewed annually. |
| assessment | n. | 评估 | 双 s 两次 | The assessment takes about an hour. |
| professor | n. | 教授 | 单 f 双 s | The professor postponed the lecture. |
| laboratory | n. | 实验室 | 北美常缩读 lab，全拼有 o-r-a | The laboratory is on the second floor. |
| library / librarian | n. | 图书馆/图书管理员 | 两个 r，常被漏成 libary | The librarian will help you locate the article. |
| February | n. | 二月 | 第一个 r 容易漏 | The semester begins in February. |
| Wednesday | n. | 星期三 | 中间的 d 不发音但要写 | The seminar is held every Wednesday. |
| receive / receipt | v./n. | 收到/收据 | i 在 e 前除非跟在 c 后 | Please keep the receipt. |
| achieve | v. | 实现 | ie 顺序，与 receive 相反 | Students achieve better results with feedback. |
| independent | adj. | 独立的 | 结尾 -ent 不是 -ant | The study was conducted by an independent body. |
| significant | adj. | 显著的 | 结尾 -ant | There was a significant improvement. |
| available | adj. | 可获得的 | 双写易错：avail + able | Additional copies are available at the desk. |
| responsible / responsibility | adj./n. | 负责的/责任 | -ible 不是 -able | Each department is responsible for its budget. |
| opportunity | n. | 机会 | 双 p，单 t 在中间 | This is a good opportunity to practise. |
| immediately | adv. | 立即 | 双 m，结尾 -ately | Report any faults immediately. |
| approximately | adv. | 大约 | 双 p，WfD 数字句高频 | The trip takes approximately two hours. |
| particularly | adv. | 尤其 | 四个音节都要拼出来 | The topic is particularly relevant. |
| although / through / thorough | conj./prep./adj. | 尽管/穿过/彻底的 | 三个词拼写极近，听力必须分辨 | A thorough review was carried out. |
| conscious / conscientious | adj. | 有意识的/尽责的 | 长词，慢速听写务必写全 | She is a conscientious employee. |
| colleague | n. | 同事 | 结尾 -eague | My colleague will cover the shift. |
| register / registration | v./n. | 注册 | WfD 校园句高频 | Registration closes at the end of the month. |
| attendance | n. | 出勤率 | 结尾 -ance 不是 -ence | Attendance has improved this term. |
| appointment | n. | 预约 | 双 p | Your appointment is confirmed for Monday. |
| guarantee | n./v. | 保证 | gua- 开头，双 e 结尾 | The warranty guarantees free repairs. |
| purchase | n./v. | 购买 | -chase 结尾 | Keep proof of purchase. |
| temperature | n. | 温度 | 中间的 era 容易漏 | The temperature dropped overnight. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| colour / favour / behaviour | n. | 颜色/偏好/行为 | 加拿大随英式保留 -our，全篇必须统一 | The behaviour policy was updated. |
| centre / theatre / metre | n. | 中心/剧院/米 | 加拿大用 -re 结尾 | Meet me at the community centre. |
| licence (n.) / license (v.) | n./v. | 执照/发执照 | 加拿大名词 -ce，动词 -se | You need a driver's licence. |
| practice (n.) / practise (v.) | n./v. | 练习 | 同上规则，与 licence 一套 | I practise speaking every day. |
| cheque | n. | 支票 | 金融用 cheque，核对用 check | I deposited the cheque yesterday. |
| enrol / enrolment | v./n. | 注册 | 加拿大单 l，美式 enroll | Enrolment closes on Friday. |
| travelled / cancelled / labelled | v. | 旅行过/取消了/标注了 | 加拿大双 l，美式单 l | The flight was cancelled. |
| organise / organize | v. | 组织 | 加拿大 -ize 更常见，两者都接受但需统一 | We organized a fundraiser. |
| defence / offence | n. | 防御/冒犯 | 加拿大 -ce，美式 -se | No offence was intended. |
| grey | adj. | 灰色 | 加拿大用 grey，美式 gray | The walls were painted grey. |
...
| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| affect (v.) / effect (n.) | v./n. | 影响（动）/影响（名） | 绝大多数情况这样分；effect 作动词意为实现 | The delay affected the schedule. / The effect was immediate. |
| advice (n.) / advise (v.) | n./v. | 建议 | c 是名词，s 是动词，发音也不同 | Thank you for your advice. / Please advise us. |
| principal / principle | adj.,n./n. | 主要的、校长/原则 | principal 是人或主要的，principle 是原则 | The principal reason is cost. |
| complement / compliment | v./n. | 补充/称赞 | e 是补充，i 是赞美 | She complimented him on the report. |
| assure / ensure / insure | v. | 使放心/确保/投保 | assure 对人，ensure 对事，insure 保险 | Please ensure the door is locked. |
| lose / loose | v./adj. | 丢失/松的 | 单 o 是动词，双 o 是形容词 | Do not lose your receipt. |
| its / it's | det./contraction | 它的/它是 | it's 只等于 it is 或 it has | The company raised its rates. |
| then / than | adv./conj. | 然后/比 | than 用于比较，中国考生高频错点 | This option is cheaper than the other. |
| economic / economical | adj. | 经济的/节省的 | economic 指经济领域，economical 指省钱 | Cycling is an economical option. |
| historic / historical | adj. | 有历史意义的/历史上的 | historic 重要，historical 属于历史 | The building is a historic landmark. |
| sensitive / sensible | adj. | 敏感的/明智的 | sensible 是明智，不是敏感 | That is a sensible suggestion. |
| efficient / effective | adj. | 高效的/有效的 | efficient 省资源，effective 达目的 | The new process is more efficient. |
| raise / rise | v. | 提高（及物）/上升（不及物） | raise 后必须带宾语 | Prices rose. / They raised prices. |
| lay / lie | v. | 放置（及物）/躺（不及物） | 过去式 laid / lay，极易混 | He laid the documents on the desk. |
| borrow / lend | v. | 借入/借出 | borrow from，lend to | Could I borrow your charger? |
| bring / take | v. | 带来/带走 | 以说话人位置为准 | Please bring your ID to the appointment. |
| few / a few / little / a little | det. | 几乎没有/一些 | few 和 little 带否定含义 | There are a few seats left. |
| amount / number | n. | 数量（不可数）/数量（可数） | the number of staff，the amount of time | A large number of residents attended. |
| fewer / less | adj. | 更少（可数）/更少（不可数） | fewer people，less time | Fewer people attended this year. |
| among / between | prep. | 在……之中/在两者之间 | between 用于两个或明确各方 | The cost is shared among all tenants. |

## ASQ · Answer Short Question 常识词

### 职业人物

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| plumber | n. | 水管工 | ASQ 问法：who fixes pipes and taps | Q: Who do you call to fix a leaking pipe? A: A plumber. |
| electrician | n. | 电工 | 问法：who works with wiring | Q: Who installs electrical wiring? A: An electrician. |
| mechanic | n. | 汽车修理工 | 问法：who repairs cars | Q: Who repairs cars? A: A mechanic. |
| pharmacist | n. | 药剂师 | 问法：who dispenses medicine | Q: Who gives you medicine at a drugstore? A: A pharmacist. |
| dentist | n. | 牙医 | 问法：who treats teeth | Q: Who treats problems with your teeth? A: A dentist. |
| veterinarian / vet | n. | 兽医 | 问法：who treats animals | Q: Who treats sick animals? A: A vet. |
| architect | n. | 建筑师 | 问法：who designs buildings | Q: Who designs buildings? A: An architect. |
| accountant | n. | 会计 | 问法：who prepares financial records | Q: Who prepares a company's accounts? A: An accountant. |
| receptionist | n. | 前台接待 | 问法：who greets visitors at an office | Q: Who greets visitors in an office lobby? A: A receptionist. |
| librarian | n. | 图书管理员 | 问法：who works in a library | Q: Who helps you find a book in a library? A: A librarian. |
| tenant / landlord | n. | 租客/房东 | 问法：who pays rent / who owns the property | Q: Who pays rent to live in a property? A: The tenant. |
| customer / client | n. | 顾客/客户 | 问法：who buys goods or services | Q: What do you call someone who buys goods? A: A customer. |
| colleague | n. | 同事 | 问法：who you work with | Q: What do you call a person you work with? A: A colleague. |

### 场所

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| pharmacy / drugstore | n. | 药房 | 问法：where you buy medicine | Q: Where do you buy prescription medicine? A: At a pharmacy. |
| post office | n. | 邮局 | 问法：where you send parcels | Q: Where do you go to mail a parcel? A: The post office. |
| bakery | n. | 面包店 | 问法：where bread is sold | Q: Where would you buy fresh bread? A: A bakery. |
| stationery shop | n. | 文具店 | 问法：where you buy pens and paper | Q: Where do you buy pens and notebooks? A: A stationery shop. |
| greenhouse | n. | 温室 | 问法：glass building for growing plants | Q: What is a glass building for growing plants called? A: A greenhouse. |
| warehouse | n. | 仓库 | 问法：where goods are stored | Q: Where are goods stored before delivery? A: In a warehouse. |
| reception / lobby | n. | 接待处/大堂 | 问法：first area you enter in a hotel | Q: Where do you check in at a hotel? A: At reception. |
| platform | n. | 站台 | 问法：where you wait for a train | Q: Where do you wait for a train? A: On the platform. |
| intersection | n. | 十字路口 | 问法：where two roads cross | Q: What do you call a place where two roads cross? A: An intersection. |

### 物品工具

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| thermometer | n. | 温度计 | 问法：instrument that measures temperature | Q: What instrument measures temperature? A: A thermometer. |
| scales | n. | 秤 | 问法：instrument that measures weight | Q: What do you use to measure weight? A: Scales. |
| compass | n. | 指南针 | 问法：shows direction | Q: What device shows you which way is north? A: A compass. |
| calendar | n. | 日历 | 问法：shows days and months | Q: What shows the days and months of the year? A: A calendar. |
| receipt | n. | 收据 | 问法：proof of purchase | Q: What proves that you paid for something? A: A receipt. |
| invoice | n. | 账单 | 问法：request for payment | Q: What document asks a customer to pay? A: An invoice. |
| ladder | n. | 梯子 | 问法：used to reach high places | Q: What do you use to reach a high shelf? A: A ladder. |
| umbrella | n. | 雨伞 | 问法：protects from rain | Q: What do you carry to stay dry in the rain? A: An umbrella. |
| microscope | n. | 显微镜 | 问法：magnifies tiny objects | Q: What instrument is used to see very small things? A: A microscope. |

### 时间数量

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| decade / century | n. | 十年/一个世纪 | 问法：how many years | Q: How many years are there in a decade? A: Ten. |
| dozen | n. | 一打（十二个） | 问法：how many in a dozen | Q: How many items are in a dozen? A: Twelve. |
| quarter | n. | 四分之一/一个季度 | 问法：three months | Q: How many months are in a quarter? A: Three. |
| fortnight | n. | 两周 | 英式说法，加拿大少用但可能出现 | Q: How many days are in a fortnight? A: Fourteen. |
| deadline | n. | 截止日期 | 问法：last date to submit | Q: What do you call the final date to submit work? A: A deadline. |

### 身体健康

| 词条 | 词性 | 中文 | 用法要点 | 例句 |
|---|---|---|---|---|
| prescription | n. | 处方 | 问法：what a doctor writes for medicine | Q: What does a doctor write so you can get medicine? A: A prescription. |
| appointment | n. | 预约 | 问法：arranged time to see someone | Q: What do you call an arranged time to see a doctor? A: An appointment. |
| bandage | n. | 绷带 | 问法：covers a wound | Q: What do you put on a cut to protect it? A: A bandage. |
| ankle / wrist / elbow | n. | 脚踝/手腕/手肘 | 关节名称，ASQ 常考身体部位 | Q: What joint connects your foot to your leg? A: The ankle. |
